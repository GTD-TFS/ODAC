...
const UI_EN = {
  ...
  "APROPIACIÓN INDEBIDA": "📦 WRONGFUL APPROPRIATION",
  "COACCIONES": "🧷 COERCION",
  ...
  "EMPLEADO DE COMERCIO AFECTADO": "AFFECTED SHOP EMPLOYEE",
  ...
  "¿AUTOR RETENIDO EN EL LUGAR?": "WAS THE OFFENDER DETAINED AT THE SCENE?",
  ...
  "SI, FACILITA CONTACTO PARA SU GESTION": "YES, CONTACT DETAILS PROVIDED FOR FOLLOW-UP",
  "GESTION DE GRABACIONES": "RECORDING MANAGEMENT",
  ...
  "SUBTIPO": "SUBTYPE",
  "TIPO DE INMUEBLE": "TYPE OF PROPERTY",
  ...
  "DEPÓSITO / CUSTODIA": "DEPOSIT / SAFEKEEPING",
...
Object.assign(UI_EN, {
  "ESTAFA / ESTAFA INFORMÁTICA": "💳 SCAM / ONLINE SCAM",
  "ESPECIFIQUE OTRO TIPO DE ESTABLECIMIENTO": "SPECIFY OTHER TYPE OF PREMISES",
  "ESPECIFIQUE OTRA ZONA DEL ESTABLECIMIENTO": "SPECIFY OTHER AREA OF THE PREMISES",
  "ESPECIFIQUE OTRO SUBTIPO DE ESTAFA": "SPECIFY OTHER SCAM SUBTYPE",
  "ESPECIFIQUE OTRO CANAL DE CONTACTO": "SPECIFY OTHER CONTACT CHANNEL",
  "ESPECIFIQUE OTRO INSTRUMENTO DE PAGO": "SPECIFY OTHER PAYMENT INSTRUMENT",
  "ESPECIFIQUE OTRO TIPO DE INMUEBLE": "SPECIFY OTHER TYPE OF PROPERTY",
  "INDIQUE QUÉ DAÑOS SE PRODUJERON": "INDICATE WHAT DAMAGE WAS CAUSED",
  "ESPECIFIQUE OTRO SUBTIPO": "SPECIFY OTHER SUBTYPE",
  "ESPECIFIQUE OTRO ORIGEN DE LA TENENCIA": "SPECIFY OTHER ORIGIN OF POSSESSION",
  "ESPECIFIQUE OTRA COACCIÓN": "SPECIFY OTHER COERCION",
  "ESPECIFIQUE OTRO ÁMBITO": "SPECIFY OTHER SCOPE",
  "ESPECIFIQUE OTRO PERJUICIO": "SPECIFY OTHER HARM",
  "Completa los campos obligatorios para continuar.": "Complete all required fields to continue.",
  "Indica cuál es el otro documento de identidad.": "Specify which other identity document it is.",
  "El número de documento es obligatorio salvo que seleccione Indocumentado/Indocumentada.": "Document number is required unless you select Undocumented.",
  "Si el número empieza por letra corresponde a NIE. Seleccione NIE como tipo de documento.": "If the number starts with a letter, it is an NIE. Select NIE as document type.",
  "Selecciona un país de DOMICILIO válido (usa las píldoras).": "Select a valid COUNTRY of residence (use the pills).",
  "Si el domicilio es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.": "If residence country is SPAIN, select PROVINCE and MUNICIPALITY.",
  "Si no reside en Tenerife, complete estancia eventual y fecha prevista de regreso.": "If you do not reside in Tenerife, complete temporary address and return date.",
});

window.QUESTION_EN = { UI_EN, GLOBAL_ROUTES, QUESTION_SETS, EXPORT_KEY_MAP };
