...
const UI_ZH = {
  "CARACTERÍSTICAS DEL HECHO": "事件类别",
  "EXTRAVÍO/PÉRDIDA": "🧳 遗失 / 丢失",
  "SUSTRACCIÓN": "🕵️ 抢劫 / 盗窃",
  "DAÑOS": "🧱 财产损坏",
  "ESTAFA / ESTAFA INFORMÁTICA": "💳 🖥️ 诈骗 / 网络诈骗",
  "AGRESIÓN": "👊 攻击 / 伤害",
  "AMENAZAS": "🗣️ 威胁",
  "OTRO TIPO DE HECHO": "➡️ 其他事件类型",
  "OTROS TIPOS DE HECHO": "其他事件类型",
  "ALLANAMIENTO / USURPACIÓN": "🏠 非法侵入 / 非法占用",
  "APROPIACIÓN INDEBIDA": "📦 侵占",
  "COACCIONES": "🧷 胁迫",
  "CARÁCTER SEXUAL": "🔒 性犯罪",
  "DENUNCIA GENÉRICA": "🧩 通用报案",
  "OTROS": "其他",
  "¿DÓNDE SE PRODUCE LA SUSTRACCIÓN?": "盗窃发生在哪里？",
  "A LA PERSONA": "针对个人",
  "EN COMERCIO (HORARIO LABORAL)": "在商店（营业时间）",
  "EN DOMICILIO / ESTABLECIMIENTO": "在住宅 / 场所",
  "TIPO DE AGRESIÓN": "侵害类型",
  "ENTORNO FAMILIAR / AFECTIVO": "家庭 / 亲密关系环境",
  "OTRO (NO FAMILIAR)": "其他（非家庭）",
  "DENUNCIA EN CALIDAD DE...": "报案身份",
  "PERJUDICADO": "受害人",
  "TESTIGO": "证人",
  "REPRESENTANTE LEGAL": "法定代表人",
  "EMPLEADO DE COMERCIO AFECTADO": "受影响的商店员工",
  "FECHA, HORA Y LUGAR DEL HECHO": "日期、时间和地点",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "日期、时间区间和地点",
  "Calle / establecimiento / municipio": "街道 / 场所 / 城市",
  "Calle / zona / municipio": "街道 / 区域 / 城市",
  "Domicilio / establecimiento / municipio": "住宅 / 场所 / 城市",
  "¿CÓMO TIENE CONOCIMIENTO DEL HECHO?": "您是如何得知该事件的？",
  "A TRAVÉS DE LA POLICÍA": "通过警方",
  "EMPRESA DE SEGURIDAD": "安保公司",
  "POR TERCERAS PERSONAS": "通过第三方",
  "DESCUBRIMIENTO POSTERIOR AL HECHO": "事后发现",
  "TESTIGO DE LOS HECHOS": "事实目击者",
  "TESTIGO DIRECTO": "直接目击者",
  "CAMARAS DE SEGURIDAD": "监控摄像头",
  "TRAS COMPROBAR PROPIEDAD FALTANTE": "发现财物缺失后",
  "¿INTERACCIÓN CON EL AUTOR?": "您是否与嫌疑人有接触？",
  "NO": "否",
  "SI, COMUNICACION / ACERCAMIENTO": "是，有沟通 / 接近",
  "SI, FORCEJEO O AGRESION": "是，有拉扯或攻击",
  "SI, INTIMIDACION SIN CONTACTO": "是，有无接触威胁",
  "¿PRESENTA LESIONES?": "是否有伤势？",
  "SI": "是",
  "DESCRIBA BREVEMENTE LAS LESIONES": "请简要描述伤势",
  "¿APORTA PARTE MÉDICO?": "是否提供诊断证明？",
  "TIPO DE INTIMIDACIÓN": "威胁/恐吓类型",
  "OBJETOS SUSTRAÍDOS": "被盗 物品",
  "DESCRIPCIÓN FÍSICA DEL AUTOR/ES": "嫌疑人体貌特征",
  "RESUMEN DE LOS HECHOS": "事件摘要",
  "¿COMO TIENE CONOCIMIENTO DEL HECHO?": "您是如何得知该事件的？",
  "¿INTERACCION CON EL AUTOR?": "您是否与嫌疑人有接触？",
  "SI, COMUNICACION": "是，有沟通",
  "¿APORTA INFORME MEDICO?": "是否提供医疗报告？",
  "¿AUTOR RETENIDO EN EL LUGAR?": "嫌疑人是否已在现场被控制？",
  "¿HAY CAMARAS DE SEGURIDAD?": "是否有监控摄像头？",
  "SI, LAS APORTA EN ESTE ACTO": "是，现在提交",
  "SI, LAS APORTARÁ EN SEDE JUDICIAL": "是，将在司法机关提交",
  "SI, FACILITA CONTACTO PARA SU GESTION": "是，提供调取所需联系方式",
  "GESTION DE GRABACIONES": "录像管理",
  "Establecimiento, contacto, ubicación, horario...": "场所、联系人、位置、营业时间...",
  "OBJETOS SUSTRAIDOS": "被盗 物品",
  "BREVE RESUMEN DE LOS HECHOS": "事件简要概述",
  "MÉTODO DE ACCESO (BREVE)": "进入方式（简要）",
  "Puerta forzada, ventana, escalo, rotura cerradura, ganzúa...": "强行破门, 窗户, 攀爬, 锁损坏, 撬锁...",
  "¿SE PRODUJERON DAÑOS?": "是否造成损坏？",
  "¿APORTA PRESUPUESTO DE REPARACIÓN?": "是否提供维修报价？",
  "DESCRIPCIÓN DE LOS DAÑOS": "损坏情况描述",
  "Describe brevemente los daños producidos...": "请简要描述造成的损坏...",
  "VALORACIÓN / PRESUPUESTO DE REPARACIÓN": "估价 / 维修报价",
  "Importe, empresa, nº presupuesto, fecha...": "金额、公司、报价编号、日期...",
  "¿HA MANIPULADO EL LUGAR DE LOS HECHOS? (PARA CONOCIMIENTO DE LA BRIGADA DE POLICÍA CIENTÍFICA)": "您是否动过现场？（供技术勘验部门参考）",
  "¿SE HA PRODUCIDO SUSTRACCIÓN?": "是否发生盗窃？",
  "BREVE DESCRIPCIÓN FÍSICA DE LOS AUTORES": "嫌疑人体貌简述",
  "Rasgos, ropa, edad aprox., altura, tatuajes...": "特征, 衣着, 大致年龄, 身高, 纹身...",
  "DESCRIPCION DE LESIONES": "伤势描述",
  "¿APORTA PARTE MEDICO?": "是否提供诊断证明？",
  "¿CONOCE AL AUTOR DE LOS HECHOS?": "您是否认识嫌疑人？",
  "APORTE DATOS": "填写相关信息",
  "DESCRIPCIÓN DEL AUTOR/ES": "嫌疑人描述",
  "VICTIMA": "受害人",
  "TIPO DE AFECTIVIDAD": "关系类型",
  "AGRESIÓN DE PAREJA (HOMBRE A MUJER) - V. GÉNERO": "伴侣暴力（男对女）- 性别暴力",
  "RESTO DE CASOS - V. DOMÉSTICA": "其他情况 - 家庭暴力",
  "¿HAY CONVIVENCIA?": "是否共同居住？",
  "¿TIENE LESIONES?": "是否有伤势？",
  "DESCRIBA LAS LESIONES": "请描述伤势",
  "¿ES SU PAREJA ACTUAL?": "是否为现任伴侣？",
  "¿CUANTO TIEMPO DE RELACION?": "这段关系持续了多久？",
  "¿Le ha agredido físicamente en otra ocasión?": "此前是否曾对您实施过肢体暴力？",
  "¿Le ha insultado, humillado o amenazado?": "是否曾侮辱、羞辱或威胁您？",
  "¿Le controla el teléfono, redes sociales o amistades?": "是否控制您的电话、社交媒体或交友？",
  "¿Le impide trabajar, estudiar o relacionarse?": "是否阻止您工作、学习或与他人交往？",
  "¿Le obliga o ha obligado a mantener relaciones sexuales?": "是否曾强迫您发生性关系？",
  "¿Ha destruido objetos o amenazado con hacerlo?": "他是否毁坏过物品或以此相威胁？",
  "¿Le ha dicho que la va a matar?": "是否曾说要杀了您？",
  "¿Ha amenazado con suicidarse si usted lo deja?": "如果您离开他，他是否曾威胁要自杀？",
  "¿Tiene acceso a armas, cuchillos u objetos peligrosos?": "他是否可接触武器/刀具/危险物品？",
  "¿Consume alcohol o drogas de forma habitual?": "是否经常饮酒或吸毒？",
  "Describe qué tipo de sustancias y habitualidad": "请说明物质类型和使用频率",
  "¿Se vuelve más violento cuando consume?": "使用后是否会变得更暴力？",
  "¿Los episodios han aumentado en frecuencia o gravedad?": "这些事件在频率或严重程度上是否有所增加？",
  "¿La violencia comenzó hace poco o lleva tiempo ocurriendo?": "暴力是最近才开始，还是已经持续一段时间？",
  "¿Ha intentado usted separarse anteriormente?": "您之前是否曾尝试分开？",
  "¿Qué ocurrió cuando lo intentó?": "您尝试时发生了什么？",
  "¿Hay menores que presencien los hechos?": "是否有未成年人目睹这些事件？",
  "¿Ha agredido o amenazado alguna vez a los menores?": "是否曾对未成年人实施攻击或威胁？",
  "¿Cree que los menores están en peligro?": "您认为未成年人处于风险中吗？",
  "¿Ha denunciado anteriormente estos hechos?": "您此前是否曾就这些事实报案？",
  "¿Tiene o ha tenido orden de protección?": "您目前或过去是否有保护令？",
  "¿Sobre el autor?": "是针对嫌疑人的吗？",
  "¿DESEA SOLICITAR ORDEN DE PROTECCIÓN?": "您是否希望申请保护令？",
  "¿Está siendo atendida por servicios sociales o sanitarios?": "您是否正在接受社会或医疗服务支持？",
  "¿Alguna persona de su entorno conoce la situación?": "您身边是否有人知道这一情况？",
  "¿Depende usted económicamente de él?": "您在经济上是否依赖他？",
  "¿Cree usted que la situación puede empeorar?": "您认为情况可能会恶化吗？",
  "¿Tiene miedo real por su vida?": "您是否真实担心自己的人身安全？",
  "¿HECHOS EN PRESENCIA DE MENORES?": "事实是否发生在未成年人在场时？",
  "¿HECHOS EN DOMICILIO FAMILIAR?": "事实是否发生在家庭住所内？",
  "¿HECHOS ANTERIORES SIMILARES?": "此前是否有类似事实？",
  "VÍNCULO CON EL AUTOR": "与嫌疑人的关系",
  "AUTOR VARÓN Y PAREJA (O SIMILAR AFECTIVIDAD EN EL PRESENTE O PASADO) - V. GÉNERO": "嫌疑人为男性且与受害人有当前或既往伴侣关系 - 性别暴力",
  "AUTOR/A DEL ENTORNO FAMILIAR - V. DOMÉSTICA": "家庭关系中的嫌疑人 - 家庭暴力",
  "OTRO": "其他",
  "NOMBRE Y/O RELACIÓN QUE LE UNE": "姓名和与其关系",
  "RELACIÓN QUE LE UNE AL AUTOR/A": "与嫌疑人的关系",
  "¿CUÁLES FUERON LAS AMENAZAS?": "具体有哪些威胁？",
  "DESCRIPCIÓN DEL AUTOR": "嫌疑人描述",
  "AÑADA DATOS DEL AUTOR": "补充嫌疑人信息",
  "FECHA, HORA Y LUGAR DEL EXTRAVÍO": "遗失的日期、时间和地点",
  "OBJETOS EXTRAVIADOS": "遗失物品",
  "CIRCUNSTANCIAS DEL EXTRAVÍO/PÉRDIDA": "遗失 / 丢失经过",
  "DETALLE ADICIONAL (OPCIONAL)": "补充说明（可选）",
  "¿SE PRODUJO SUSTRACCIÓN DE OBJETOS?": "是否有物品被盗？",
  "OBJETOS AFECTADOS/SUSTRAÍDOS": "受影响/被盗物品",
  "¿HAY CÁMARAS DE SEGURIDAD?": "是否有监控摄像头？",
  "GESTIÓN DE GRABACIONES": "录像管理",
  "¿APORTA INFORME/PARTE MÉDICO?": "是否提供医疗报告/诊断证明？",
  "¿SE PRODUJO SUSTRACCIÓN?": "是否发生盗窃？",
  "OBJETOS AFECTADOS": "受影响物品",
  "DATOS / DESCRIPCIÓN DEL AUTOR": "嫌疑人信息 / 描述",
  "TIPO DE COACCIÓN": "胁迫类型",
  "ÁMBITO": "领域",
  "MEDIO UTILIZADO": "使用方式",
  "REITERACIÓN": "重复性",
  "NÚMERO APROXIMADO DE EVENTOS": "大致事件次数",
  "PERJUICIO PRINCIPAL": "主要损害",
  "SUBTIPO DE ESTAFA": "诈骗子类型",
  "FECHA, HORA Y LUGAR/CANAL DEL HECHO": "事件的日期、时间和地点 / 渠道",
  "OPERATIVA ECONÓMICA": "支付操作",
  "CANAL DE CONTACTO": "联系渠道",
  "INSTRUMENTO DE PAGO": "支付工具",
  "IMPORTE TOTAL ESTIMADO (€)": "金额 (€)",
  "NÚMERO APROXIMADO DE OPERACIONES": "大致交易次数",
  "IDENTIFICADORES Y EVIDENCIAS": "识别信息和证据",
  "ENTIDAD BANCARIA (SI APLICA)": "银行机构（如适用）",
  "IDENTIFICADORES RELACIONADOS": "相关 标识信息",
  "EVIDENCIAS DISPONIBLES": "可用 证据",
  "TIPO DE AMENAZA": "威胁类型",
  "ESPECIFIQUE OTRA AMENAZA": "请说明其他威胁",
  "SUBTIPO": "子类型",
  "TIPO DE INMUEBLE": "不动产类型",
  "MÉTODO DE ACCESO": "进入方式",
  "ESPECIFIQUE OTRO MÉTODO DE ACCESO": "请说明其他进入方式",
  "SITUACIÓN ACTUAL": "当前状况",
  "ORIGEN DE LA TENENCIA": "占有来源",
  "¿REQUIRIÓ LA DEVOLUCIÓN?": "是否已要求返还？",
  "FECHA DEL REQUERIMIENTO": "要求返还日期",
  "MEDIO DEL REQUERIMIENTO": "要求方式",
  "RESPUESTA DEL REQUERIDO": "被要求方回应",
  "IMPORTE ESTIMADO (€)": "金额 (€)",
  "CONTEXTO DE LA VÍCTIMA": "受害人情况",
  "LESIONES": "伤势",
  "RELACIÓN CON EL AUTOR (V. GÉNERO)": "与嫌疑人的关系（性别暴力）",
  "INDICADORES DE RIESGO (I)": "风险指标",
  "INDICADORES DE RIESGO (II)": "风险指标",
  "ANTECEDENTES Y MENORES": "前情与未成年人",
  "PROTECCIÓN Y APOYO": "保护与支持",
  "VALORACIÓN V. DOMÉSTICA": "家庭暴力评估",
  "CONTEXTO DE RELACIÓN": "关系背景",
  "MÉTODO DE SUSTRACCIÓN": "窃取方式",
  "ESPECIFIQUE OTRO MÉTODO DE SUSTRACCIÓN": "请说明其他窃取方式",
  "TIPO DE DAÑOS": "损坏类型",
  "TIPO DE ESTABLECIMIENTO": "场所类型",
  "ZONA DEL ESTABLECIMIENTO": "场所区域",
  "ESPECIFIQUE OTRO TIPO DE DAÑO": "请说明其他损坏类型",
  "TELÉFONO": "电话",
  "MENSAJERÍA": "消息渠道",
  "OTRA": "其他",
  "LABORAL": "工作",
  ...
  "COMPRA/VENTA": "买卖",
  "SUPLANTACIÓN": "冒充",
  "IMPEDIR HACER ALGO": "阻止做某事",
  "OBLIGAR A HACER ALGO": "强迫做某事",
  "CONTROL DE MOVILIDAD": "行动控制",
  "ALLANAMIENTO DE MORADA": "非法侵入住处",
  "USURPACIÓN DE INMUEBLE": "非法占用不动产",
  "OCUPACIÓN TEMPORAL": "临时占用",
  "VIVIENDA HABITUAL": "主要住所",
  "SEGUNDA VIVIENDA": "第二住所",
  "LOCAL": "场所",
  "NAVE": "仓库",
  "SOLAR": "地块",
  "ESCALO": "攀爬侵入",
  "FRACTURA CERRADURA": "锁具破坏",
  "FORZAMIENTO PUERTA": "强行破门",
  "FORZAMIENTO VENTANA": "强行撬窗",
  "LLAVE FALSA / SUSTRAÍDA": "伪造/被盗钥匙",
  "LLAVE FALSA / LLAVE SUSTRAÍDA": "伪造/被盗钥匙",
  "SIGUEN DENTRO": "仍在内部",
  "YA NO ESTÁN": "已不在现场",
  "NO SABE": "未知",
  "OBJETO ENTREGADO Y NO DEVUELTO": "已交付物品未归还",
  "DEPÓSITO / CUSTODIA": "寄存 / 保管",
  "ALQUILER NO DEVUELTO": "租赁物未归还",
  "ERROR DE ENTREGA": "交付错误",
  "PRÉSTAMO": "借用",
  "DEPÓSITO": "寄存",
  "ALQUILER": "租赁",
  "RELACIÓN LABORAL": "劳动关系",
  "WHATSAPP": "WHATSAPP",
  "BUROFAX": "挂号存证函",
  "LLAMADA": "电话",
  "SE NIEGA": "拒绝",
  "NO CONTESTA": "不回应",
  "PROMETE DEVOLVER": "承诺归还",
  "AMENAZA": "威胁",
  "AMENAZA DE MUERTE": "死亡威胁",
  "AMENAZA DE LESIÓN": "伤害威胁",
  "AMENAZA DE DAÑOS EN BIENES": "以损坏财物相威胁",
  "AMENAZA A MENORES": "针对未成年人的威胁",
  "AMENAZA CONDICIONAL": "附条件威胁",
  "SIN INTIMIDACIÓN": "无威胁",
  "VERBAL": "口头",
  ...
  "ARMA BLANCA": "刀具",
  "ARMA DE FUEGO": "枪支",
  "OTRO OBJETO PELIGROSO": "其他危险物品",
  "DESCUIDO": "疏忽",
  "ARREBATO": "抢夺",
  "BOLSILLO": "扒窃",
  "INHIBIDOR / SISTEMA ELECTRÓNICO": "干扰器/电子系统",
  "OCULTACIÓN DE OBJETO": "藏匿物品",
  "SUPERMERCADO": "超市",
  "FARMACIA": "药店",
  "TIENDA ROPA / COMPLEMENTOS": "服装/配饰店",
  "ESTANCO / LOTERÍA": "烟草店 / 彩票店",
  "HOSTELERÍA": "餐饮业",
  "ALMACÉN": "仓库",
  "LÍNEA DE CAJA": "收银区",
  "MOSTRADOR": "柜台",
  ...
  "PUERTA": "门",
  "VENTANA": "窗户",
  "TERRAZA / EXTERIOR": "露台/室外",
  "IBAN, teléfono, email, URL, usuario...": "IBAN、电话、邮箱、URL、用户名...",
  "Ej.: 1250": "例如：1250",
  "Ej.: 3": "例如：3",
  "Ej.: 850": "例如：850",
  "Ej.: Banco X": "例如：X银行",
  "MÓVIL": "电话",
  "CARTERA / MONEDERO": "钱包/皮夹",
  "DOCUMENTACIÓN": "证件文件",
  "JOYAS": "珠宝",
  "HERRAMIENTA": "工具",
  "BICICLETA": "自行车",
  "PATINETE": "滑板车",
  "PORTÁTIL / TABLET": "笔记本/平板",
  "MOCHILA / BOLSO": "背包/包",
  "HOMBRE": "男性",
  "MUJER": "女性",
  "NO DETERMINADO": "未确定",
  "DELGADA": "瘦",
  "NORMAL": "中等",
  "FUERTE/CORPULENTA": "强壮/壮实",
  "ATLÉTICA": "运动型",
  "NO DETERMINADA": "未确定",
  "AÑADIR / EDITAR OBJETOS": "添加 / 编辑物品",
  "Sin objetos.": "无物品。",
  "X": "X",
  "Selecciona una NACIONALIDAD válida (usa las píldoras).": "请选择有效国籍（使用候选按钮）。",
  "Selecciona un PAÍS de nacimiento válido (usa las píldoras).": "请选择有效出生国家（使用候选按钮）。",
  "Si el país de nacimiento es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.": "若出生国家为西班牙，请选择省和市镇。"
};
...
Object.assign(UI_ZH, {
  "ESTAFA / ESTAFA INFORMÁTICA": "💳 诈骗 / 网络诈骗",
  "ESPECIFIQUE OTRO TIPO DE ESTABLECIMIENTO": "请说明其他场所类型",
  "ESPECIFIQUE OTRA ZONA DEL ESTABLECIMIENTO": "请说明场所内其他区域",
  "ESPECIFIQUE OTRO SUBTIPO DE ESTAFA": "请说明其他诈骗子类型",
  "ESPECIFIQUE OTRO CANAL DE CONTACTO": "请说明其他联系渠道",
  "ESPECIFIQUE OTRO INSTRUMENTO DE PAGO": "请说明其他支付工具",
  "ESPECIFIQUE OTRO TIPO DE INMUEBLE": "请说明其他不动产类型",
  "INDIQUE QUÉ DAÑOS SE PRODUJERON": "请说明造成了哪些损坏",
  "ESPECIFIQUE OTRO SUBTIPO": "请说明其他子类型",
  "ESPECIFIQUE OTRO ORIGEN DE LA TENENCIA": "请说明其他占有来源",
  "ESPECIFIQUE OTRA COACCIÓN": "请说明其他胁迫情形",
  "ESPECIFIQUE OTRO ÁMBITO": "请说明其他范围",
  "ESPECIFIQUE OTRO PERJUICIO": "请说明其他损害",
