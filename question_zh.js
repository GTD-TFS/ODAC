...
const UI_ZH = {
  ...
  "EMPLEADO DE COMERCIO AFECTADO": "受影响 员工",
  ...
  "¿CÓMO TIENE CONOCIMIENTO DEL HECHO?": "如何 是否 您 得知 知晓 的 该 事件?",
  "A TRAVÉS DE LA POLICÍA": "通过 该 警方",
  "EMPRESA DE SEGURIDAD": "安全 公司",
  "POR TERCERAS PERSONAS": "通过 第三方",
  "DESCUBRIMIENTO POSTERIOR AL HECHO": "事后发现",
  "TESTIGO DE LOS HECHOS": "证人 给 该 事件",
  "TESTIGO DIRECTO": "直接 证人",
  "CAMARAS DE SEGURIDAD": "监控摄像头",
  "TRAS COMPROBAR PROPIEDAD FALTANTE": "发现后 财产 缺失",
  "¿INTERACCIÓN CON EL AUTOR?": "是否 您 接触 与 该 嫌疑人?",
  "NO": "否",
  "SI, COMUNICACION / ACERCAMIENTO": "是, 沟通 / 接近",
  "SI, FORCEJEO O AGRESION": "是, 拉扯 或 攻击",
  "SI, INTIMIDACION SIN CONTACTO": "是, 威胁 无 联系",
  "¿PRESENTA LESIONES?": "是否 您 有 伤势?",
  "SI": "是",
  "DESCRIBA BREVEMENTE LAS LESIONES": "简要 描述 该 伤势",
  "¿APORTA PARTE MÉDICO?": "是否 您 提供 医疗 报告?",
  "TIPO DE INTIMIDACIÓN": "威胁/恐吓类型",
  "OBJETOS SUSTRAÍDOS": "被盗 物品",
  "DESCRIPCIÓN FÍSICA DEL AUTOR/ES": "体貌 描述 的 嫌疑人",
  "RESUMEN DE LOS HECHOS": "事件摘要",
  "¿COMO TIENE CONOCIMIENTO DEL HECHO?": "如何 是否 您 得知 知晓 的 该 事件?",
  "¿INTERACCION CON EL AUTOR?": "是否 您 接触 与 该 嫌疑人?",
  "SI, COMUNICACION": "是, 沟通",
  "¿APORTA INFORME MEDICO?": "是否 您 提供 医疗 报告?",
  "¿AUTOR RETENIDO EN EL LUGAR?": "是否 该 嫌疑人 控制 在 现场?",
  "¿HAY CAMARAS DE SEGURIDAD?": "是否有监控摄像头？",
  "SI, LAS APORTA EN ESTE ACTO": "是, 提交 现在",
  "SI, LAS APORTARÁ EN SEDE JUDICIAL": "是, 将 被 提交 给 法院",
  "SI, FACILITA CONTACTO PARA SU GESTION": "是, 提供 联系 用于 调取",
  "GESTION DE GRABACIONES": "录像管理",
  "Establecimiento, contacto, ubicación, horario...": "场所, 联系, 地址, 营业 时间...",
  "OBJETOS SUSTRAIDOS": "被盗 物品",
  "BREVE RESUMEN DE LOS HECHOS": "简述 摘要",
  "MÉTODO DE ACCESO (BREVE)": "方式 的 进入 (简述)",
  "Puerta forzada, ventana, escalo, rotura cerradura, ganzúa...": "强行破门, 窗户, 攀爬, 锁损坏, 撬锁...",
  "¿SE PRODUJERON DAÑOS?": "是否 有 损坏?",
  "¿APORTA PRESUPUESTO DE REPARACIÓN?": "是否 您 提供 修复 报价?",
  "DESCRIPCIÓN DE LOS DAÑOS": "描述 的 损坏",
  "Describe brevemente los daños producidos...": "简要 描述 该 损坏...",
  "VALORACIÓN / PRESUPUESTO DE REPARACIÓN": "/ 修复 报价",
  "Importe, empresa, nº presupuesto, fecha...": "金额, 公司, 报价 否., 日期...",
  "¿HA MANIPULADO EL LUGAR DE LOS HECHOS? (PARA CONOCIMIENTO DE LA BRIGADA DE POLICÍA CIENTÍFICA)": "有 您 任何物品 在 该 现场? (用于 刑侦鉴识 知悉)",
  "¿SE HA PRODUCIDO SUSTRACCIÓN?": "是否 任何物品 被盗?",
  "BREVE DESCRIPCIÓN FÍSICA DE LOS AUTORES": "简述 体貌 描述 的 嫌疑人",
  "Rasgos, ropa, edad aprox., altura, tatuajes...": "特征, 衣着, 大致年龄, 身高, 纹身...",
  "DESCRIPCION DE LESIONES": "描述 的 伤势",
  "¿APORTA PARTE MEDICO?": "是否 您 提供 医疗 报告?",
  "¿CONOCE AL AUTOR DE LOS HECHOS?": "是否 您 认识 该 嫌疑人?",
  "APORTE DATOS": "提供 详情",
  "DESCRIPCIÓN DEL AUTOR/ES": "描述 的 嫌疑人",
  "VICTIMA": "受害人",
  "TIPO DE AFECTIVIDAD": "关系 类型",
  "AGRESIÓN DE PAREJA (HOMBRE A MUJER) - V. GÉNERO": "伴侣 ( 给 ) - 性别暴力",
  "RESTO DE CASOS - V. DOMÉSTICA": "其他 情况 - 家庭暴力",
  "¿HAY CONVIVENCIA?": "是否 您 共同居住?",
  "¿TIENE LESIONES?": "是否 您 有 伤势?",
  "DESCRIBA LAS LESIONES": "描述 该 伤势",
  "¿ES SU PAREJA ACTUAL?": "是否 现任伴侣?",
  "¿CUANTO TIEMPO DE RELACION?": "如何 多久 有 您 在 此事 关系?",
  "¿Le ha agredido físicamente en otra ocasión?": "您 之前?",
  "¿Le ha insultado, humillado o amenazado?": ", 或 您?",
  "¿Le controla el teléfono, redes sociales o amistades?": "电话, 社交媒体 或 社交关系?",
  "¿Le impide trabajar, estudiar o relacionarse?": "您 从 工作, 学习 或 社交?",
  "¿Le obliga o ha obligado a mantener relaciones sexuales?": "您 给 有 性关系?",
  "¿Ha destruido objetos o amenazado con hacerlo?": "他是否毁坏过物品或以此相威胁？",
  "¿Le ha dicho que la va a matar?": "将 杀害 您?",
  "¿Ha amenazado con suicidarse si usted lo deja?": "自杀 您 ?",
  "¿Tiene acceso a armas, cuchillos u objetos peligrosos?": "他是否可接触武器/刀具/危险物品？",
  "¿Consume alcohol o drogas de forma habitual?": "酒精 或 毒品?",
  "Describe qué tipo de sustancias y habitualidad": "描述 物质 和 频率",
  "¿Se vuelve más violento cuando consume?": "得知 更暴力 何时 ?",
  "¿Los episodios han aumentado en frecuencia o gravedad?": "有 在 频率 或 严重程度?",
  "¿La violencia comenzó hace poco o lleva tiempo ocurriendo?": "是否 近期 或 在 用于 一段时间?",
  "¿Ha intentado usted separarse anteriormente?": "有 您 给 之前?",
  "¿Qué ocurrió cuando lo intentó?": "什么 何时 您 ?",
  "¿Hay menores que presencien los hechos?": "是否有未成年人目睹这些事件？",
  "¿Ha agredido o amenazado alguna vez a los menores?": "或 该 ?",
  "¿Cree que los menores están en peligro?": "您认为未成年人处于风险中吗？",
  "¿Ha denunciado anteriormente estos hechos?": "有 您 已报案这些事实 之前?",
  "¿Tiene o ha tenido orden de protección?": "是否 您 有 / 有 您 保护令?",
  "¿Sobre el autor?": "该 嫌疑人?",
  "¿DESEA SOLICITAR ORDEN DE PROTECCIÓN?": "是否 您 给 保护令?",
  "¿Está siendo atendida por servicios sociales o sanitarios?": "您是否正在接受社会或医疗服务支持？",
  "¿Alguna persona de su entorno conoce la situación?": "周围人员 您 认识 关于 此事?",
  "¿Depende usted económicamente de él?": "您在经济上是否依赖他？",
  "¿Cree usted que la situación puede empeorar?": "是否 您 该 ?",
  "¿Tiene miedo real por su vida?": "您是否真实担心自己的人身安全？",
  "¿HECHOS EN PRESENCIA DE MENORES?": "事件 在 该 在场 的 ?",
  "¿HECHOS EN DOMICILIO FAMILIAR?": "事件 在 该 家庭 住宅?",
  "¿HECHOS ANTERIORES SIMILARES?": "事件?",
  "VÍNCULO CON EL AUTOR": "关系 给 该 嫌疑人",
  "AUTOR VARÓN Y PAREJA (O SIMILAR AFECTIVIDAD EN EL PRESENTE O PASADO) - V. GÉNERO": "嫌疑人 和 伴侣 (或 , ) - 性别暴力",
  "AUTOR/A DEL ENTORNO FAMILIAR - V. DOMÉSTICA": "家庭成员 嫌疑人 - 家庭暴力",
  "OTRO": "其他",
  "NOMBRE Y/O RELACIÓN QUE LE UNE": "姓名和/或关系",
  "RELACIÓN QUE LE UNE AL AUTOR/A": "关系 详情",
  "¿CUÁLES FUERON LAS AMENAZAS?": "具体有哪些威胁？",
  "DESCRIPCIÓN DEL AUTOR": "描述 的 嫌疑人",
  "AÑADA DATOS DEL AUTOR": "嫌疑人 详情",
  "FECHA, HORA Y LUGAR DEL EXTRAVÍO": "日期, 时间 和 地点 的 遗失",
  "OBJETOS EXTRAVIADOS": "物品",
  "CIRCUNSTANCIAS DEL EXTRAVÍO/PÉRDIDA": "情况 的 该 遗失",
  "DETALLE ADICIONAL (OPCIONAL)": "附加 详情 (可选)",
  ...
  "OBJETOS AFECTADOS": "受影响 物品",
  "DATOS / DESCRIPCIÓN DEL AUTOR": "嫌疑人 详情 / 描述",
  "TIPO DE COACCIÓN": "类型 的 胁迫",
  "ÁMBITO": "范围",
  "MEDIO UTILIZADO": "使用方式",
  "REITERACIÓN": "重复性",
  "NÚMERO APROXIMADO DE EVENTOS": "大致事件次数",
  "PERJUICIO PRINCIPAL": "主要损害",
  "SUBTIPO DE ESTAFA": "诈骗 子类型",
  "FECHA, HORA Y LUGAR/CANAL DEL HECHO": "日期, 时间 和 地点/渠道 的 该 事件",
  "OPERATIVA ECONÓMICA": "支付操作",
  "CANAL DE CONTACTO": "联系 渠道",
  "INSTRUMENTO DE PAGO": "支付工具",
  "IMPORTE TOTAL ESTIMADO (€)": "金额 (€)",
  "NÚMERO APROXIMADO DE OPERACIONES": "大致交易次数",
  "IDENTIFICADORES Y EVIDENCIAS": "标识信息 和 证据",
  "ENTIDAD BANCARIA (SI APLICA)": "银行 机构 (如适用)",
  "IDENTIFICADORES RELACIONADOS": "相关 标识信息",
  "EVIDENCIAS DISPONIBLES": "可用 证据",
  "TIPO DE AMENAZA": "威胁类型",
  "ESPECIFIQUE OTRA AMENAZA": "请说明其他威胁",
  "SUBTIPO": "子类型",
  "TIPO DE INMUEBLE": "财产 类型",
  "MÉTODO DE ACCESO": "方式",
  "ESPECIFIQUE OTRO MÉTODO DE ACCESO": "其他 方式",
  ...
  "IMPORTE ESTIMADO (€)": "金额 (€)",
  "CONTEXTO DE LA VÍCTIMA": "受害人 背景",
  "LESIONES": "伤势",
  "RELACIÓN CON EL AUTOR (V. GÉNERO)": "关系 与 嫌疑人 (性别暴力)",
  "INDICADORES DE RIESGO (I)": "风险指标",
  "INDICADORES DE RIESGO (II)": "风险指标",
  "ANTECEDENTES Y MENORES": "前情与未成年人",
  "PROTECCIÓN Y APOYO": "保护与支持",
  "VALORACIÓN V. DOMÉSTICA": "家庭暴力 评估",
  "CONTEXTO DE RELACIÓN": "关系 背景",
  "MÉTODO DE SUSTRACCIÓN": "盗窃 方式",
  "ESPECIFIQUE OTRO MÉTODO DE SUSTRACCIÓN": "其他 盗窃 方式",
  "TIPO DE DAÑOS": "类型 的 损坏",
  "TIPO DE ESTABLECIMIENTO": "场所类型",
  "ZONA DEL ESTABLECIMIENTO": "场所区域",
  "ESPECIFIQUE OTRO TIPO DE DAÑO": "其他 类型 的 损坏",
  "TELÉFONO": "电话",
  "MENSAJERÍA": "消息渠道",
  "OTRA": "其他",
  "LABORAL": "工作",
  ...
  "ALLANAMIENTO DE MORADA": "住宅 侵入",
  "USURPACIÓN DE INMUEBLE": "财产 非法占用",
  "OCUPACIÓN TEMPORAL": "临时占用",
  "VIVIENDA HABITUAL": "主要住所",
  "SEGUNDA VIVIENDA": "第二 住宅",
  "LOCAL": "场所",
  "NAVE": "仓库",
  "SOLAR": "地块",
  "ESCALO": "攀爬 进入",
