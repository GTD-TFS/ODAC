...
const UI_ZH = {
  ...
  "¿APORTA INFORME/PARTE MÉDICO?": "是否 您 提供 医疗 报告?",
  "¿SE PRODUJO SUSTRACCIÓN?": "是否 有 盗窃?",
  ...
  "REITERACIÓN": "重复性",
  "NÚMERO APROXIMADO DE EVENTOS": "的 事件",
  ...
  "NÚMERO APROXIMADO DE OPERACIONES": "的 交易次数",
  ...
  "ORIGEN DE LA TENENCIA": "的",
  "¿REQUIRIÓ LA DEVOLUCIÓN?": "是否 您 ?",
  "FECHA DEL REQUERIMIENTO": "日期 的",
  "MEDIO DEL REQUERIMIENTO": "渠道",
  "RESPUESTA DEL REQUERIDO": "的",
  "IMPORTE ESTIMADO (€)": "金额 (€)",
  ...
  "ANTECEDENTES Y MENORES": "背景 和",
  "PROTECCIÓN Y APOYO": "和",
  ...
  "IBAN, teléfono, email, URL, usuario...": "IBAN, 电话, email, URL, ...",
  "Ej.: 1250": ".: 1250",
  "Ej.: 3": ".: 3",
  "Ej.: 850": ".: 850",
  "Ej.: Banco X": ".: 银行 X",
  ...
  "Sin objetos.": "否 物品.",
  "X": "X",
  "Selecciona una NACIONALIDAD válida (usa las píldoras).": "国籍 ( 该 ).",
  "Selecciona un PAÍS de nacimiento válido (usa las píldoras).": "国家 的 出生 ( 该 ).",
  "Si el país de nacimiento es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.": "该 国家 的 出生 是否 , 和 ."
};
