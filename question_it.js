...
const UI_IT = {
  ...
  "CARACTERÍSTICAS DEL HECHO": "CATEGORIA DEL FATTO",
  ...
  "OTROS TIPOS DE HECHO": "ALTRI TIPI DI FATTO",
  "ALLANAMIENTO / USURPACIÓN": "🏠 TRESPASS / SQUATTING",
  "APROPIACIÓN INDEBIDA": "📦 MISAPPROPRIATION",
  "COACCIONES": "🧷 COERCION",
  "CARÁCTER SEXUAL": "🔒 SEXUAL OFFENCE",
  "DENUNCIA GENÉRICA": "🧩 DENUNCIA GENERICA",
  "OTROS": "ALTRO",

  // ===== SELECTORES =====
  "¿DÓNDE SE PRODUCE LA SUSTRACCIÓN?": "DOVE AVVIENE LA SOTTRAZIONE?",
  "A LA PERSONA": "FROM A PERSON",
  "EN COMERCIO (HORARIO LABORAL)": "IN NEGOZIO (ORARIO LAVORATIVO)",
  "EN DOMICILIO / ESTABLECIMIENTO": "IN A HOME / PREMISES",

  "TIPO DE AGRESIÓN": "TIPO DI AGGRESSIONE",
  "ENTORNO FAMILIAR / AFECTIVO": "FAMILY / INTIMATE CONTEXT",
  "OTRO (NO FAMILIAR)": "ALTRO (NON FAMILIARE)",

  // ===== COMUNES =====
  "DENUNCIA EN CALIDAD DE...": "DENUNCIA IN QUALITA DI...",
  "PERJUDICADO": "VITTIMA",
  "TESTIGO": "TESTIMONE",
  "REPRESENTANTE LEGAL": "LEGAL REPRESENTATIVE",
  "EMPLEADO DE COMERCIO AFECTADO": "AFFECTED EMPLOYEE",

  "FECHA, HORA Y LUGAR DEL HECHO": "DATA, ORA E LUOGO",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATA, INTERVALLO ORARIO E LUOGO",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATA, INTERVALLO ORARIO E LUOGO",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATA, INTERVALLO ORARIO E LUOGO",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATA, INTERVALLO ORARIO E LUOGO",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATA, INTERVALLO ORARIO E LUOGO",
  ...
  "¿CÓMO TIENE CONOCIMIENTO DEL HECHO?": "COME E VENUTO A CONOSCENZA DEL FATTO?",
  "A TRAVÉS DE LA POLICÍA": "TRAMITE LA POLIZIA",
  "EMPRESA DE SEGURIDAD": "AZIENDA DI SICUREZZA",
  "POR TERCERAS PERSONAS": "TRAMITE TERZI",
  "DESCUBRIMIENTO POSTERIOR AL HECHO": "SCOPERTO SUCCESSIVAMENTE",
  "TESTIGO DE LOS HECHOS": "TESTIMONE DEL FATTO",
  "TESTIGO DIRECTO": "TESTIMONE DIRETTO",
  "CAMARAS DE SEGURIDAD": "TELECAMERE DI SICUREZZA",
  "TRAS COMPROBAR PROPIEDAD FALTANTE": "AFTER NOTICING PROPERTY MISSING",

  // ===== HURTO_RVI =====
  "¿INTERACCIÓN CON EL AUTOR?": "HA AVUTO INTERAZIONE CON L’AUTORE?",
  "NO": "NO",
  "SI, COMUNICACION / ACERCAMIENTO": "SÌ, COMUNICAZIONE / AVVICINAMENTO",
  "SI, FORCEJEO O AGRESION": "SÌ, COLLUTTAZIONE O AGGRESSIONE",
  "SI, INTIMIDACION SIN CONTACTO": "SÌ, MINACCE SENZA CONTATTO",
  "¿PRESENTA LESIONES?": "DO YOU HAVE INJURIES?",
  "SI": "SÌ",
  "DESCRIBA BREVEMENTE LAS LESIONES": "DESCRIVA BREVEMENTE LE LESIONI",
  "¿APORTA PARTE MÉDICO?": "ALLEGHI REFERTO/PARTE MEDICO?",
  "TIPO DE INTIMIDACIÓN": "TIPO DI MINACCIA/INTIMIDAZIONE",
  "OBJETOS SUSTRAÍDOS": "OGGETTI SOTTRATTI",
  "DESCRIPCIÓN FÍSICA DEL AUTOR/ES": "DESCRIZIONE FISICA DELL’AUTORE/I",
  "RESUMEN DE LOS HECHOS": "RIEPILOGO DEI FATTI",

  // ===== PATRIMONIO =====
  "¿COMO TIENE CONOCIMIENTO DEL HECHO?": "COME E VENUTO A CONOSCENZA DEL FATTO?",
  "¿INTERACCION CON EL AUTOR?": "HA AVUTO INTERAZIONE CON L’AUTORE?",
  "SI, COMUNICACION": "SÌ, COMUNICAZIONE",
  "¿APORTA INFORME MEDICO?": "ALLEGHI REFERTO/PARTE MEDICO?",
  "¿AUTOR RETENIDO EN EL LUGAR?": "AUTORE TRATTENUTO SUL POSTO?",
  "¿HAY CAMARAS DE SEGURIDAD?": "CI SONO TELECAMERE?",
  "SI, LAS APORTA EN ESTE ACTO": "SÌ, FORNITE ORA",
  "SI, LAS APORTARÁ EN SEDE JUDICIAL": "SÌ, SARANNO FORNITE IN SEGUITO",
  "SI, FACILITA CONTACTO PARA SU GESTION": "SÌ, FORNISCO CONTATTO",
  "GESTION DE GRABACIONES": "GESTIONE REGISTRAZIONI",
  "Establecimiento, contacto, ubicación, horario...": "Premises, contact, address, opening hours...",
  "OBJETOS SUSTRAIDOS": "OGGETTI SOTTRATTI",
  "BREVE RESUMEN DE LOS HECHOS": "BREVE RIEPILOGO",

  // ===== ROBO_FUERZA =====
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATA, INTERVALLO ORARIO E LUOGO",
  "MÉTODO DE ACCESO (BREVE)": "METODO DI ACCESSO (BREVE)",
  "Puerta forzada, ventana, escalo, rotura cerradura, ganzúa...": "Porta forzata, finestra, scavalcamento, serratura rotta, grimaldello...",
  "¿SE PRODUJERON DAÑOS?": "CI SONO STATI DANNI?",
  "¿APORTA PRESUPUESTO DE REPARACIÓN?": "DO YOU PROVIDE A REPAIR QUOTE?",
  "DESCRIPCIÓN DE LOS DAÑOS": "DESCRIZIONE DEI DANNI",
  "Describe brevemente los daños producidos...": "Descriva brevemente i danni...",
  "VALORACIÓN / PRESUPUESTO DE REPARACIÓN": "VALUATION / REPAIR QUOTE",
  "Importe, empresa, nº presupuesto, fecha...": "Importo, azienda, n. preventivo, data...",
  ...
  "¿SE HA PRODUCIDO SUSTRACCIÓN?": "C’È STATA SOTTRAZIONE?",
  "OBJETOS SUSTRAÍDOS": "OGGETTI SOTTRATTI",
  "BREVE DESCRIPCIÓN FÍSICA DE LOS AUTORES": "BREVE DESCRIZIONE FISICA DEGLI AUTORI",
  ...
  // ===== LESIONES =====
  "DESCRIPCION DE LESIONES": "DESCRIZIONE LESIONI",
  "¿APORTA PARTE MEDICO?": "ALLEGHI REFERTO/PARTE MEDICO?",
  "¿CONOCE AL AUTOR DE LOS HECHOS?": "CONOSCE L’AUTORE?",
  "APORTE DATOS": "PROVIDE DETAILS",
  "DESCRIPCIÓN DEL AUTOR/ES": "DESCRIZIONE DELL’AUTORE/I",

  // ===== AGRESION_FAMILIAR_AFECTIVO =====
  "DENUNCIA EN CALIDAD DE...": "DENUNCIA IN QUALITA DI...",
  "VICTIMA": "VITTIMA",
  "TIPO DE AFECTIVIDAD": "TIPO DI RELAZIONE",
  "AGRESIÓN DE PAREJA (HOMBRE A MUJER) - V. GÉNERO": "INTIMATE PARTNER VIOLENCE (MALE TO FEMALE) - GENDER VIOLENCE",
  "RESTO DE CASOS - V. DOMÉSTICA": "ALTRI CASI - VIOLENZA DOMESTICA",
  "¿HAY CONVIVENCIA?": "DO YOU LIVE TOGETHER?",
  "¿TIENE LESIONES?": "DO YOU HAVE INJURIES?",
  "DESCRIBA LAS LESIONES": "DESCRIVA LE LESIONI",
  "¿APORTA INFORME MEDICO?": "ALLEGHI REFERTO/PARTE MEDICO?",
  "¿ES SU PAREJA ACTUAL?": "IS HE YOUR CURRENT PARTNER?",
  "¿CUANTO TIEMPO DE RELACION?": "DA QUANTO TEMPO DURA LA RELAZIONE?",
  ...
  "¿Le controla el teléfono, redes sociales o amistades?": "CONTROLLA IL SUO TELEFONO, SOCIAL O AMICIZIE?",
  ...
  "Describe qué tipo de sustancias y habitualidad": "DESCRIVA SOSTANZE E FREQUENZA",
  ...
  "¿Hay menores que presencien los hechos?": "CI SONO MINORI CHE HANNO ASSISTITO AI FATTI?",
  "¿Ha agredido o amenazado alguna vez a los menores?": "HA MAI AGGREDITO O MINACCIATO I MINORI?",
  "¿Cree que los menores están en peligro?": "RITIENE CHE I MINORI SIANO IN PERICOLO?",
  "¿Ha denunciado anteriormente estos hechos?": "HAVE YOU REPORTED THESE FACTS BEFORE?",
  "¿Tiene o ha tenido orden de protección?": "HA/HAD UN ORDINE DI PROTEZIONE?",
  "¿Sobre el autor?": "CONTRO L’AUTORE?",
  "¿DESEA SOLICITAR ORDEN DE PROTECCIÓN?": "VUOLE RICHIEDERE ORDINE DI PROTEZIONE?",
  ...
  "¿Cree usted que la situación puede empeorar?": "CREDE CHE LA SITUAZIONE POSSA PEGGIORARE?",
  "¿Tiene miedo real por su vida?": "ARE YOU GENUINELY AFRAID FOR YOUR LIFE?",

  // VD block
  "¿HECHOS EN PRESENCIA DE MENORES?": "FATTI IN PRESENZA DI MINORI?",
  "¿HECHOS EN DOMICILIO FAMILIAR?": "FATTI NELL ABITAZIONE FAMILIARE?",
  "¿HECHOS ANTERIORES SIMILARES?": "FATTI PRECEDENTI SIMILI?",

  // ===== AMENAZAS_GLOBAL =====
  "VÍNCULO CON EL AUTOR": "LEGAME CON L’AUTORE",
  ...
  "OTRO": "ALTRO",
  "NOMBRE Y/O RELACIÓN QUE LE UNE": "NOME E/O RELAZIONE",
  "RELACIÓN QUE LE UNE AL AUTOR/A": "DETTAGLI RELAZIONE",
  "¿CUÁLES FUERON LAS AMENAZAS?": "QUALI SONO STATE LE MINACCE?",
  "DESCRIPCIÓN DEL AUTOR": "DESCRIZIONE DELL’AUTORE",

  // ===== CARACTER_SEXUAL =====
  "AÑADA DATOS DEL AUTOR": "AGGIUNGI DATI AUTORE",
  "DESCRIPCIÓN DEL AUTOR": "DESCRIZIONE DELL’AUTORE",

  // ===== EXTRAVIO =====
  "FECHA, HORA Y LUGAR DEL EXTRAVÍO": "DATA, ORA E LUOGO DELLO SMARRIMENTO",
  "OBJETOS EXTRAVIADOS": "OGGETTI SMARRITI",
  "CIRCUNSTANCIAS DEL EXTRAVÍO/PÉRDIDA": "CIRCOSTANZE DELLO SMARRIMENTO",

  // ===== OTROS =====
  "BREVE RESUMEN DE LOS HECHOS": "BREVE RIEPILOGO",
  "RESUMEN DE LOS HECHOS": "RIEPILOGO DEI FATTI",
  "DETALLE ADICIONAL (OPCIONAL)": "ADDITIONAL DETAIL (OPTIONAL)",
  "¿SE PRODUJO SUSTRACCIÓN DE OBJETOS?": "C E STATA SOTTRAZIONE DI OGGETTI?",
  "OBJETOS AFECTADOS/SUSTRAÍDOS": "AFFECTED/STOLEN OBJECTS",
  "¿HAY CÁMARAS DE SEGURIDAD?": "CI SONO TELECAMERE DI SICUREZZA?",
  "GESTIÓN DE GRABACIONES": "RECORDING MANAGEMENT",
  "¿APORTA INFORME/PARTE MÉDICO?": "ALLEGHI REFERTO/PARTE MEDICO?",
  "¿SE PRODUJO SUSTRACCIÓN?": "C E STATA SOTTRAZIONE?",
  "OBJETOS AFECTADOS": "OGGETTI COINVOLTI",
  "DATOS / DESCRIPCIÓN DEL AUTOR": "DATI / DESCRIZIONE AUTORE",
  "DESCRIPCIÓN DEL AUTOR/ES": "DESCRIZIONE DELL’AUTORE/I",
  "TIPO DE COACCIÓN": "TIPO DI COAZIONE",
  "ÁMBITO": "SCOPE",
  "MEDIO UTILIZADO": "MEZZO UTILIZZATO",
  "REITERACIÓN": "REPETITION",
  "NÚMERO APROXIMADO DE EVENTOS": "NUMERO APPROSSIMATO EVENTI",
  ...
  "NÚMERO APROXIMADO DE OPERACIONES": "NUMERO APPROSSIMATO OPERAZIONI",
  ...
  "TIPO DE AMENAZA": "TIPO DI MINACCIA",
  "ESPECIFIQUE OTRA AMENAZA": "SPECIFICARE ALTRA MINACCIA",
  "SUBTIPO": "SUBTYPE",
  "TIPO DE INMUEBLE": "TIPO DI IMMOBILE",
  "MÉTODO DE ACCESO": "METODO DI ACCESSO",
  "ESPECIFIQUE OTRO MÉTODO DE ACCESO": "SPECIFICARE ALTRO METODO DI ACCESSO",
  "SITUACIÓN ACTUAL": "CURRENT SITUATION",
  "ORIGEN DE LA TENENCIA": "ORIGINE DEL POSSESSO",
  "¿REQUIRIÓ LA DEVOLUCIÓN?": "DID YOU REQUEST RETURN?",
  "FECHA DEL REQUERIMIENTO": "DATA DELLA RICHIESTA",
  "MEDIO DEL REQUERIMIENTO": "MEZZO DELLA RICHIESTA",
  "RESPUESTA DEL REQUERIDO": "RISPOSTA DEL DESTINATARIO",
  "IMPORTE ESTIMADO (€)": "IMPORTO STIMATO (€)",
  "CONTEXTO DE LA VÍCTIMA": "CONTESTO DELLA VITTIMA",
  "LESIONES": "INJURIES",
  "RELACIÓN CON EL AUTOR (V. GÉNERO)": "RELAZIONE CON L’AUTORE (VIOLENZA DI GENERE)",
  "INDICADORES DE RIESGO (I)": "RISK INDICATORS (I)",
  "INDICADORES DE RIESGO (II)": "RISK INDICATORS (II)",
  "ANTECEDENTES Y MENORES": "PRECEDENTI E MINORI",
  "PROTECCIÓN Y APOYO": "PROTEZIONE E SUPPORTO",
  "VALORACIÓN V. DOMÉSTICA": "DOMESTIC VIOLENCE ASSESSMENT",
  "CONTEXTO DE RELACIÓN": "CONTESTO RELAZIONE",
  "¿CUÁLES FUERON LAS AMENAZAS?": "QUALI SONO STATE LE MINACCE?",
  "MÉTODO DE SUSTRACCIÓN": "METODO DI SOTTRAZIONE",
  "ESPECIFIQUE OTRO MÉTODO DE SUSTRACCIÓN": "SPECIFICARE ALTRO METODO DI SOTTRAZIONE",
  "TIPO DE DAÑOS": "TIPO DI DANNO",
  "TIPO DE ESTABLECIMIENTO": "TIPO DI ESERCIZIO",
  ...
  "NAVE": "WAREHOUSE",
  "SOLAR": "LOT/LAND",
  "ESCALO": "SCAVALCAMENTO",
  "FRACTURA CERRADURA": "ROTTURA SERRATURA",
  "FORZAMIENTO PUERTA": "PORTA FORZATA",
  "FORZAMIENTO VENTANA": "FINESTRA FORZATA",
  "LLAVE FALSA / SUSTRAÍDA": "FALSE/STOLEN KEY",
  "LLAVE FALSA / LLAVE SUSTRAÍDA": "FALSE/STOLEN KEY",
  "SIGUEN DENTRO": "STILL INSIDE",
  "YA NO ESTÁN": "NON CI SONO PIÙ",
  "NO SABE": "UNKNOWN",
  ...
  "DEPÓSITO": "DEPOSIT",
  "ALQUILER": "RENTAL",
  "RELACIÓN LABORAL": "RELAZIONE LAVORATIVA",
  "WHATSAPP": "WHATSAPP",
  "BUROFAX": "BUROFAX",
  "LLAMADA": "CALL",
  "SE NIEGA": "REFUSES",
  "NO CONTESTA": "NESSUNA RISPOSTA",
  "PROMETE DEVOLVER": "PROMISES TO RETURN",
  "AMENAZA DE MUERTE": "DEATH THREAT",
  "AMENAZA DE LESIÓN": "INJURY THREAT",
  "AMENAZA DE DAÑOS EN BIENES": "MINACCIA DI DANNI A BENI",
  "AMENAZA A MENORES": "THREAT TO MINORS",
  "AMENAZA CONDICIONAL": "CONDITIONAL THREAT",
  "SIN INTIMIDACIÓN": "SENZA INTIMIDAZIONE",
  "VERBAL": "VERBAL",
  "GESTUAL": "GESTURAL",
  "ARMA BLANCA": "BLADED WEAPON",
  "ARMA DE FUEGO": "FIREARM",
  "OTRO OBJETO PELIGROSO": "ALTRO OGGETTO PERICOLOSO",
  "DESCUIDO": "LAPSE/CARELESSNESS",
  "ARREBATO": "SNATCHING",
  "BOLSILLO": "POCKET",
  "INHIBIDOR / SISTEMA ELECTRÓNICO": "JAMMER / ELECTRONIC SYSTEM",
  "OCULTACIÓN DE OBJETO": "OCCULTAMENTO OGGETTO",
  "SUPERMERCADO": "SUPERMARKET",
  "FARMACIA": "PHARMACY",
  "TIENDA ROPA / COMPLEMENTOS": "NEGOZIO ABBIGLIAMENTO / ACCESSORI",
  "ESTANCO / LOTERÍA": "TABACCHI / LOTTERIA",
  "HOSTELERÍA": "RISTORAZIONE",
  "ALMACÉN": "MAGAZZINO",
  "LÍNEA DE CAJA": "CORSIA CASSA",
  "MOSTRADOR": "BANCO",
  "PROBADORES": "CAMERINI",
  "MOBILIARIO": "ARREDI",
  "VEHÍCULO": "VEICOLO",
  ...
  "PUERTA": "PORTA",
  "VENTANA": "FINESTRA",
  "TERRAZA / EXTERIOR": "TERRAZZA / ESTERNO",
  ...
  "MÓVIL": "CELLULARE",
  "CARTERA / MONEDERO": "PORTAFOGLIO",
  "DOCUMENTACIÓN": "DOCUMENTI",
  "JOYAS": "GIOIELLI",
  "HERRAMIENTA": "ATTREZZI",
  "BICICLETA": "BICICLETTA",
  "PATINETE": "MONOPATTINO",
  "PORTÁTIL / TABLET": "PORTATILE / TABLET",
  "MOCHILA / BOLSO": "ZAINO / BORSA",
  "HOMBRE": "MASCHIO",
  "MUJER": "FEMMINA",
  "NO DETERMINADO": "NON DETERMINATO",
  "DELGADA": "MAGRA",
  "NORMAL": "NORMALE",
  "FUERTE/CORPULENTA": "ROBUSTA",
  "ATLÉTICA": "ATLETICA",
  "NO DETERMINADA": "NON DETERMINATA",

  // ===== OBJETOS MODAL =====
  "AÑADIR / EDITAR OBJETOS": "AGGIUNGI / MODIFICA OGGETTI",
  "Sin objetos.": "Nessun oggetto.",
  "X": "X",

  // ===== VALIDACIÓN =====
  "Selecciona una NACIONALIDAD válida (usa las píldoras).":
    "Seleziona una NAZIONALITA valida (usa le pillole).",
  "Selecciona un PAÍS de nacimiento válido (usa las píldoras).":
    "Seleziona un PAESE DI NASCITA valido (usa le pillole).",
  "Si el país de nacimiento es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.":
    "Se il paese di nascita e SPAGNA, seleziona PROVINCIA e COMUNE."
};
...
Object.assign(UI_IT, {
  ...
  "OTRO TIPO DE HECHO": "➡️ ALTRO TIPO DI FATTO",
  "OTROS TIPOS DE HECHO": "ALTRI TIPI DI FATTO",
  "ALLANAMIENTO / USURPACIÓN": "🏠 VIOLAZIONE DI DOMICILIO / OCCUPAZIONE",
  "APROPIACIÓN INDEBIDA": "📦 APPROPRIAZIONE INDEBITA",
  "COACCIONES": "🧷 COAZIONI",
  "CARÁCTER SEXUAL": "🔒 REATO SESSUALE",
  "DENUNCIA GENÉRICA": "🧩 DENUNCIA GENERICA",
  "SI": "SÌ",
  "NO": "NO",
  "PERJUDICADO": "PARTE OFFESA",
  "TESTIGO": "TESTIMONE",
  "REPRESENTANTE LEGAL": "RAPPRESENTANTE LEGALE",
  "VICTIMA": "VITTIMA",
  "DENUNCIA EN CALIDAD DE...": "DENUNCIA IN QUALITÀ DI...",
  "C E STATA SOTTRAZIONE DI OGGETTI?": "C'È STATA SOTTRAZIONE DI OGGETTI?",
  "CI SONO TELECAMERE DI SICUREZZA?": "CI SONO TELECAMERE DI SICUREZZA?",
  "RECORDING MANAGEMENT": "GESTIONE REGISTRAZIONI",
  "AFFECTED/STOLEN OBJECTS": "OGGETTI COINVOLTI/SOTTRATTI",
  "RIEPILOGO DEI FATTI": "RIEPILOGO DEI FATTI",
  "ALTRI TIPI DI FATTO": "ALTRI TIPI DI FATTO",
  "GENERIC REPORT": "DENUNCIA GENERICA",
  "INCIDENT CATEGORY": "CATEGORIA DEL FATTO",
  "REPORTING AS...": "DENUNCIA IN QUALITÀ DI...",
  "TESTIMONE": "TESTIMONE",
  "VITTIMA": "VITTIMA",
  "LEGAL REPRESENTATIVE": "RAPPRESENTANTE LEGALE",
  "DOVE AVVIENE LA SOTTRAZIONE?": "DOVE AVVIENE LA SOTTRAZIONE?",
  "TIPO DI AGGRESSIONE": "TIPO DI AGGRESSIONE",
  "ADD / EDIT ITEMS": "AGGIUNGI / MODIFICA OGGETTI"
});
...
// Auto-fix: replace remaining EN values with IT
(function patchEnglishValues(ui){
  const MAP = {
  "ADDITIONAL DETAIL (OPTIONAL)": "DETTAGLIO AGGIUNTIVO (OPZIONALE)",
  "AFFECTED EMPLOYEE": "DIPENDENTE DEL NEGOZIO COINVOLTO",
  "AFTER NOTICING PROPERTY MISSING": "DOPO AVER NOTATO LA MANCANZA",
  "ARE YOU BEING ASSISTED BY SOCIAL OR HEALTH SERVICES?": "È SEGUITA DA SERVIZI SOCIALI O SANITARI?",
  "ARE YOU FINANCIALLY DEPENDENT ON HIM?": "DIPENDE ECONOMICAMENTE DA LUI?",
  "ARE YOU GENUINELY AFRAID FOR YOUR LIFE?": "HA REALE PAURA PER LA SUA VITA?",
  "AUDIOS": "AUDIO",
  "AVAILABLE EVIDENCE": "PROVE DISPONIBILI",
  "BANKING": "BANCARIA",
  "BLADED WEAPON": "ARMA BIANCA",
  "BUROFAX": "BUROFAX",
  "BUY/SELL": "ACQUISTO/VENDITA",
  "CALL": "CHIAMATA",
  "CARD": "CARTA",
  "CASH": "CONTANTI",
  "CONDITIONAL THREAT": "MINACCIA CONDIZIONALE",
  "CRYPTOCURRENCY": "CRIPTOVALUTA",
  "CURRENT SITUATION": "SITUAZIONE ATTUALE",
  "DEATH THREAT": "MINACCIA DI MORTE",
  "DELIVERED OBJECT NOT RETURNED": "OGGETTO CONSEGNATO E NON RESTITUITO",
  "DELIVERY ERROR": "ERRORE DI CONSEGNA",
  "DEPOSIT": "DEPOSITO",
  "DEPOSIT / CUSTODY": "DEPOSITO / CUSTODIA",
  "DID VIOLENCE START RECENTLY OR HAS IT BEEN GOING ON FOR A WHILE?": "LA VIOLENZA È INIZIATA DA POCO O VA AVANTI DA TEMPO?",
  "DID YOU REQUEST RETURN?": "HA RICHIESTO LA RESTITUZIONE?",
  "DO YOU HAVE INJURIES?": "HA LESIONI?",
  "DO YOU LIVE TOGETHER?": "C'È CONVIVENZA?",
  "DO YOU PROVIDE A REPAIR QUOTE?": "ALLEGA PREVENTIVO DI RIPARAZIONE?",
  "DOES ANYONE AROUND YOU KNOW ABOUT THIS?": "QUALCUNO DEL SUO AMBIENTE CONOSCE LA SITUAZIONE?",
  "DOES HE BECOME MORE VIOLENT WHEN USING?": "DIVENTA PIÙ VIOLENTO QUANDO ASSUME?",
  "DOES HE HAVE ACCESS TO WEAPONS/KNIVES/DANGEROUS OBJECTS?": "HA ACCESSO AD ARMI/COLTELLI/OGGETTI PERICOLOSI?",
  "DOES HE PREVENT YOU FROM WORKING, STUDYING OR SOCIALIZING?": "LE IMPEDISCE DI LAVORARE, STUDIARE O RELAZIONARSI?",
  "DOES HE REGULARLY USE ALCOHOL OR DRUGS?": "CONSUMA ALCOL O DROGHE ABITUALMENTE?",
  "DOMESTIC VIOLENCE ASSESSMENT": "VALUTAZIONE VIOLENZA DOMESTICA",
  "ECONOMIC": "ECONOMICO",
  "ESTABLISHMENT AREA": "ZONA DELL'ESERCIZIO",
  "FALSE/STOLEN KEY": "CHIAVE FALSA/RUBATA",
  "FAMILY": "FAMILIARE",
  "FAMILY / INTIMATE CONTEXT": "CONTESTO FAMILIARE / AFFETTIVO",
  "FAMILY MEMBER OFFENDER - DOMESTIC VIOLENCE": "AUTORE DEL CONTESTO FAMILIARE - VIOLENZA DOMESTICA",
  "FIREARM": "ARMA DA FUOCO",
  "FORCE DOING SOMETHING": "OBBLIGARE A FARE QUALCOSA",
  "FROM A PERSON": "ALLA PERSONA",
  "Features, clothing, approx. age, height, tattoos...": "Tratti, abbigliamento, età approx., altezza, tatuaggi...",
  "GESTURAL": "GESTUALE",
  "HAS HE DESTROYED OBJECTS OR THREATENED TO?": "HA DISTRUTTO OGGETTI O MINACCIATO DI FARLO?",
  "HAS HE FORCED YOU TO HAVE SEXUAL RELATIONS?": "L'HA COSTRETTA A RAPPORTI SESSUALI?",
  "HAS HE INSULTED, HUMILIATED OR THREATENED YOU?": "L'HA INSULTATA, UMILIATA O MINACCIATA?",
  "HAS HE PHYSICALLY ASSAULTED YOU BEFORE?": "L'HA AGGREDITA FISICAMENTE IN ALTRE OCCASIONI?",
  "HAS HE SAID HE WILL KILL YOU?": "LE HA DETTO CHE LA UCCIDERÀ?",
  "HAS HE THREATENED SUICIDE IF YOU LEAVE?": "HA MINACCIATO IL SUICIDIO SE LO LASCIA?",
  "HAVE EPISODES INCREASED IN FREQUENCY OR SEVERITY?": "GLI EPISODI SONO AUMENTATI IN FREQUENZA O GRAVITÀ?",
  "HAVE YOU REPORTED THESE FACTS BEFORE?": "HA GIÀ DENUNCIATO QUESTI FATTI?",
  "HAVE YOU TOUCHED/MOVED ANYTHING AT THE SCENE? (FOR FORENSICS AWARENESS)": "HA MANIPOLATO IL LUOGO DEI FATTI? (PER LA POLIZIA SCIENTIFICA)",
  "HAVE YOU TRIED TO LEAVE BEFORE?": "HA GIÀ TENTATO DI SEPARARSI?",
  "HOME TRESPASS": "VIOLAZIONE DI DOMICILIO",
  "Home / premises / city": "Domicilio / esercizio / comune",
  "IMPERSONATION": "SUPPLANTAZIONE DI IDENTITÀ",
  "IN A HOME / PREMISES": "IN DOMICILIO / ESERCIZIO",
  "IN PERSON": "PRESENZIALE",
  "INJURIES": "LESIONI",
  "INJURY THREAT": "MINACCIA DI LESIONE",
  "INTIMATE PARTNER VIOLENCE (MALE TO FEMALE) - GENDER VIOLENCE": "AGGRESSIONE DI COPPIA (UOMO A DONNA) - VIOLENZA DI GENERE",
  "IS HE YOUR CURRENT PARTNER?": "È IL SUO PARTNER ATTUALE?",
  "JAMMER / ELECTRONIC SYSTEM": "INIBITORE / SISTEMA ELETTRONICO",
  "LAPSE/CARELESSNESS": "DISATTENZIONE",
  "LAPTOP / TABLET": "PORTATILE / TABLET",
  "LOAN": "PRESTITO",
  "LOT/LAND": "TERRENO",
  "MAIN HARM": "PREGIUDIZIO PRINCIPALE",
  "MALE OFFENDER AND PARTNER (OR SIMILAR, CURRENT/PAST) - GENDER VIOLENCE": "AUTORE MASCHIO E PARTNER (O AFFETTIVITÀ SIMILE, PRESENTE/PASSATA) - VIOLENZA DI GENERE",
  "MESSAGES": "MESSAGGI",
  "MESSAGING": "MESSAGGERIA",
  "MOVEMENT CONTROL": "CONTROLLO DEGLI SPOSTAMENTI",
  "NEIGHBORHOOD": "VICINATO",
  "NONE": "NESSUNA",
  "PARTNER": "PARTNER",
  "PAYMENT INSTRUMENT": "STRUMENTO DI PAGAMENTO",
  "PAYMENT OPERATION": "OPERATIVA ECONOMICA",
  "PERSONAL": "PERSONALE",
  "PHARMACY": "FARMACIA",
  "PHISHING": "PHISHING",
  "POCKET": "TASCA",
  "PREMISES": "LOCALE",
  "PREVENT DOING SOMETHING": "IMPEDIRE DI FARE QUALCOSA",
  "PRIMARY RESIDENCE": "ABITAZIONE PRINCIPALE",
  "PROMISES TO RETURN": "PROMETTE DI RESTITUIRE",
  "PROPERTY SQUATTING": "USURPAZIONE DI IMMOBILE",
  "PROVIDE DETAILS": "APPORTI DATI",
  "Premises, contact, address, opening hours...": "Esercizio, contatto, indirizzo, orario...",
  "RECEIPTS": "GIUSTIFICATIVI",
  "REFUSES": "SI RIFIUTA",
  "RELATED IDENTIFIERS": "IDENTIFICATORI CORRELATI",
  "RENTAL": "NOLEGGIO",
  "RENTAL NOT RETURNED": "NOLEGGIO NON RESTITUITO",
  "REPEATED": "REITERATO",
  "REPETITION": "REITERAZIONE",
  "RISK INDICATORS (I)": "INDICATORI DI RISCHIO (I)",
  "RISK INDICATORS (II)": "INDICATORI DI RISCHIO (II)",
  "SCAM SUBTYPE": "SOTTOTIPO DI TRUFFA",
  "SCOPE": "AMBITO",
  "SCREENSHOTS": "CATTURE",
  "SECOND HOME": "SECONDA CASA",
  "SEVERAL": "VARIE",
  "SNATCHING": "STRAPPO",
  "SOCIAL MEDIA": "SOCIAL",
  "STILL INSIDE": "SONO ANCORA DENTRO",
  "SUBTYPE": "SOTTOTIPO",
  "SUPERMARKET": "SUPERMERCATO",
  "Street / area / city": "Strada / zona / comune",
  "Street / premises / city": "Strada / esercizio / comune",
  "TEMPORARY OCCUPATION": "OCCUPAZIONE TEMPORANEA",
  "THIRD PARTIES": "TERZI",
  "THREAT TO MINORS": "MINACCIA A MINORI",
  "TRANSFER": "BONIFICO",
  "UNKNOWN": "NON SA",
  "VALUATION / REPAIR QUOTE": "VALUTAZIONE / PREVENTIVO RIPARAZIONE",
  "VERBAL": "VERBALE",
  "WAREHOUSE": "MAGAZZINO",
  "WHAT HAPPENED WHEN YOU TRIED?": "COSA È SUCCESSO QUANDO HA PROVATO?",
  "WHATSAPP": "WHATSAPP",
  "WORKPLACE": "LAVORATIVO",
  "X": "X"
};
  for (const k of Object.keys(ui)){
    const v = ui[k];
