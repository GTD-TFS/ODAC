...
const UI_JA = {
  ...
  "TIPO DE AGRESIÓN": "加害タイプ",
  "ENTORNO FAMILIAR / AFECTIVO": "家族・親密関係",
  "OTRO (NO FAMILIAR)": "その他（非家族）",
  "DENUNCIA EN CALIDAD DE...": "申告の立場...",
  "PERJUDICADO": "被害者",
  "TESTIGO": "目撃者",
  "REPRESENTANTE LEGAL": "法定代理人",
  "EMPLEADO DE COMERCIO AFECTADO": "被害 従業員",
  ...
  "¿CÓMO TIENE CONOCIMIENTO DEL HECHO?": "どのように か あなたは 知る 認識 の その 事案?",
  "A TRAVÉS DE LA POLICÍA": "通じて その 警察",
  "EMPRESA DE SEGURIDAD": "防犯 会社",
  "POR TERCERAS PERSONAS": "通じて 第三者",
  "DESCUBRIMIENTO POSTERIOR AL HECHO": "事後に判明",
  "TESTIGO DE LOS HECHOS": "目撃者 へ その 事案",
  "TESTIGO DIRECTO": "直接 目撃者",
  "CAMARAS DE SEGURIDAD": "防犯カメラ",
  "TRAS COMPROBAR PROPIEDAD FALTANTE": "確認後 財産 欠損",
  "¿INTERACCIÓN CON EL AUTOR?": "か あなたは 接触 と その 加害者?",
  "NO": "いいえ",
  "SI, COMUNICACION / ACERCAMIENTO": "はい, 会話 / 接近",
  "SI, FORCEJEO O AGRESION": "はい, もみ合い または 暴行",
  "SI, INTIMIDACION SIN CONTACTO": "はい, 脅迫 なし 連絡",
  "¿PRESENTA LESIONES?": "か あなたは ある けが?",
  "SI": "はい",
  "DESCRIBA BREVEMENTE LAS LESIONES": "簡潔に 記載 その けが",
  "¿APORTA PARTE MÉDICO?": "か あなたは 提出 医療 報告?",
  "TIPO DE INTIMIDACIÓN": "脅迫・威嚇の種類",
  "OBJETOS SUSTRAÍDOS": "盗難 物品",
  "DESCRIPCIÓN FÍSICA DEL AUTOR/ES": "身体的 説明 の 加害者",
  "RESUMEN DE LOS HECHOS": "事実の要約",
  "¿COMO TIENE CONOCIMIENTO DEL HECHO?": "どのように か あなたは 知る 認識 の その 事案?",
  "¿INTERACCION CON EL AUTOR?": "か あなたは 接触 と その 加害者?",
  "SI, COMUNICACION": "はい, 会話",
  "¿APORTA INFORME MEDICO?": "か あなたは 提出 医療 報告?",
  "¿AUTOR RETENIDO EN EL LUGAR?": "ですか その 加害者 確保 に 現場?",
  "¿HAY CAMARAS DE SEGURIDAD?": "防犯カメラはありますか？",
  "SI, LAS APORTA EN ESTE ACTO": "はい, 提出 現在",
  "SI, LAS APORTARÁ EN SEDE JUDICIAL": "はい, 予定 される 提出 へ 裁判所",
  "SI, FACILITA CONTACTO PARA SU GESTION": "はい, 提出 連絡 ため 回収",
  "GESTION DE GRABACIONES": "映像管理",
  "Establecimiento, contacto, ubicación, horario...": "施設, 連絡, 住所, 営業 時間...",
  "OBJETOS SUSTRAIDOS": "盗難 物品",
  "BREVE RESUMEN DE LOS HECHOS": "簡潔 要約",
  "MÉTODO DE ACCESO (BREVE)": "方法 の 侵入 (簡潔)",
  "Puerta forzada, ventana, escalo, rotura cerradura, ganzúa...": "ドア破壊, 窓, よじ登り, 鍵破損, ピッキング...",
  "¿SE PRODUJERON DAÑOS?": "でしたか ある 損害?",
  "¿APORTA PRESUPUESTO DE REPARACIÓN?": "か あなたは 提出 修理 見積?",
  "DESCRIPCIÓN DE LOS DAÑOS": "説明 の 損害",
  "Describe brevemente los daños producidos...": "簡潔に 記載 その 損害...",
  "VALORACIÓN / PRESUPUESTO DE REPARACIÓN": "/ 修理 見積",
  "Importe, empresa, nº presupuesto, fecha...": "金額, 会社, 見積 いいえ., 日付...",
  "¿HA MANIPULADO EL LUGAR DE LOS HECHOS? (PARA CONOCIMIENTO DE LA BRIGADA DE POLICÍA CIENTÍFICA)": "ある あなたは 何か で その 現場? (ため 鑑識 把握)",
  "¿SE HA PRODUCIDO SUSTRACCIÓN?": "でしたか 何か 盗難?",
  "BREVE DESCRIPCIÓN FÍSICA DE LOS AUTORES": "簡潔 身体的 説明 の 加害者",
  "Rasgos, ropa, edad aprox., altura, tatuajes...": "特徴, 服装, おおよその年齢, 身長, 入れ墨...",
  "DESCRIPCION DE LESIONES": "説明 の けが",
  "¿APORTA PARTE MEDICO?": "か あなたは 提出 医療 報告?",
  "¿CONOCE AL AUTOR DE LOS HECHOS?": "か あなたは 知っている その 加害者?",
  "APORTE DATOS": "提出 詳細",
  "DESCRIPCIÓN DEL AUTOR/ES": "説明 の 加害者",
  "VICTIMA": "被害者",
  "TIPO DE AFECTIVIDAD": "関係 タイプ",
  "AGRESIÓN DE PAREJA (HOMBRE A MUJER) - V. GÉNERO": "パートナー ( へ ) - ジェンダー暴力",
  "RESTO DE CASOS - V. DOMÉSTICA": "その他 事例 - 家庭内暴力",
  "¿HAY CONVIVENCIA?": "か あなたは 同居?",
  "¿TIENE LESIONES?": "か あなたは ある けが?",
  "DESCRIBA LAS LESIONES": "記載 その けが",
  "¿ES SU PAREJA ACTUAL?": "ですか 現在のパートナー?",
  "¿CUANTO TIEMPO DE RELACION?": "どのように どれくらい ある あなたは で この件 関係?",
  "¿Le ha agredido físicamente en otra ocasión?": "あなたは 以前?",
  "¿Le ha insultado, humillado o amenazado?": ", または あなたは?",
  "¿Le controla el teléfono, redes sociales o amistades?": "電話, または 交友関係?",
  "¿Le impide trabajar, estudiar o relacionarse?": "あなたは から 就労, 学習 または 交流?",
  "¿Le obliga o ha obligado a mantener relaciones sexuales?": "あなたは へ ある 性的関係?",
  "¿Ha destruido objetos o amenazado con hacerlo?": "物を壊した、または壊すと脅したことはありますか？",
  "¿Le ha dicho que la va a matar?": "予定 殺害 あなたは?",
  "¿Ha amenazado con suicidarse si usted lo deja?": "自殺 あなたは ?",
  "¿Tiene acceso a armas, cuchillos u objetos peligrosos?": "武器・刃物・危険物にアクセスできますか？",
  "¿Consume alcohol o drogas de forma habitual?": "アルコール または 薬物?",
  "Describe qué tipo de sustancias y habitualidad": "記載 物質 と 頻度",
  "¿Se vuelve más violento cuando consume?": "知る より暴力的 いつ ?",
  "¿Los episodios han aumentado en frecuencia o gravedad?": "ある で 頻度 または 深刻度?",
  "¿La violencia comenzó hace poco o lleva tiempo ocurriendo?": "か 最近 または に ため 期間?",
  "¿Ha intentado usted separarse anteriormente?": "ある あなたは へ 以前?",
  "¿Qué ocurrió cuando lo intentó?": "何 いつ あなたは ?",
  "¿Hay menores que presencien los hechos?": "これらの出来事を目撃した未成年者はいますか？",
  "¿Ha agredido o amenazado alguna vez a los menores?": "または その ?",
  "¿Cree que los menores están en peligro?": "未成年者が危険な状態だと思いますか？",
  "¿Ha denunciado anteriormente estos hechos?": "ある あなたは これらの事実を申告 以前?",
  "¿Tiene o ha tenido orden de protección?": "か あなたは ある / ある あなたは 保護命令?",
  "¿Sobre el autor?": "その 加害者?",
  "¿DESEA SOLICITAR ORDEN DE PROTECCIÓN?": "か あなたは へ 保護命令?",
  "¿Está siendo atendida por servicios sociales o sanitarios?": "福祉・医療サービスの支援を受けていますか？",
  "¿Alguna persona de su entorno conoce la situación?": "周囲の人 あなたは 知っている について この件?",
  "¿Depende usted económicamente de él?": "経済的に彼に依存していますか？",
  "¿Cree usted que la situación puede empeorar?": "か あなたは その ?",
  "¿Tiene miedo real por su vida?": "生命の危険を本当に感じますか？",
  "¿HECHOS EN PRESENCIA DE MENORES?": "事案 で その 同席 の ?",
  "¿HECHOS EN DOMICILIO FAMILIAR?": "事案 で その 家族 住居?",
  "¿HECHOS ANTERIORES SIMILARES?": "事案?",
  "VÍNCULO CON EL AUTOR": "関係 へ その 加害者",
  "AUTOR VARÓN Y PAREJA (O SIMILAR AFECTIVIDAD EN EL PRESENTE O PASADO) - V. GÉNERO": "加害者 と パートナー (または , ) - ジェンダー暴力",
  "AUTOR/A DEL ENTORNO FAMILIAR - V. DOMÉSTICA": "家族 加害者 - 家庭内暴力",
  "OTRO": "その他",
  "NOMBRE Y/O RELACIÓN QUE LE UNE": "氏名および/または関係",
  "RELACIÓN QUE LE UNE AL AUTOR/A": "関係 詳細",
  "¿CUÁLES FUERON LAS AMENAZAS?": "どのような脅迫がありましたか？",
  "DESCRIPCIÓN DEL AUTOR": "説明 の 加害者",
  "AÑADA DATOS DEL AUTOR": "加害者 詳細",
  "FECHA, HORA Y LUGAR DEL EXTRAVÍO": "日付, 時間 と 場所 の 紛失",
  "OBJETOS EXTRAVIADOS": "物品",
  "CIRCUNSTANCIAS DEL EXTRAVÍO/PÉRDIDA": "状況 の その 紛失",
  "DETALLE ADICIONAL (OPCIONAL)": "追加 詳細 (任意)",
  ...
  "¿APORTA INFORME/PARTE MÉDICO?": "か あなたは 提出 医療 報告?",
  "¿SE PRODUJO SUSTRACCIÓN?": "でしたか ある 窃盗?",
  "OBJETOS AFECTADOS": "被害 物品",
  "DATOS / DESCRIPCIÓN DEL AUTOR": "加害者 詳細 / 説明",
  "TIPO DE COACCIÓN": "タイプ の 強要",
  "ÁMBITO": "範囲",
  "MEDIO UTILIZADO": "手段",
  "REITERACIÓN": "反復",
  "NÚMERO APROXIMADO DE EVENTOS": "の 事実",
  "PERJUICIO PRINCIPAL": "主な被害",
  "SUBTIPO DE ESTAFA": "詐欺 サブタイプ",
  "FECHA, HORA Y LUGAR/CANAL DEL HECHO": "日付, 時間 と 場所/経路 の その 事案",
  "OPERATIVA ECONÓMICA": "支払処理",
  "CANAL DE CONTACTO": "連絡 経路",
  "INSTRUMENTO DE PAGO": "決済手段",
  "IMPORTE TOTAL ESTIMADO (€)": "金額 (€)",
  "NÚMERO APROXIMADO DE OPERACIONES": "の 取引回数",
  "IDENTIFICADORES Y EVIDENCIAS": "識別情報 と 証拠",
  "ENTIDAD BANCARIA (SI APLICA)": "銀行 機関 (該当する場合)",
  ...
  "SUBTIPO": "サブタイプ",
  "TIPO DE INMUEBLE": "財産 タイプ",
  "MÉTODO DE ACCESO": "方法",
  "ESPECIFIQUE OTRO MÉTODO DE ACCESO": "その他 方法",
  "SITUACIÓN ACTUAL": "現在の状況",
  "ORIGEN DE LA TENENCIA": "の",
  "¿REQUIRIÓ LA DEVOLUCIÓN?": "か あなたは ?",
  "FECHA DEL REQUERIMIENTO": "日付 の",
  "MEDIO DEL REQUERIMIENTO": "経路",
  "RESPUESTA DEL REQUERIDO": "の",
  "IMPORTE ESTIMADO (€)": "金額 (€)",
  "CONTEXTO DE LA VÍCTIMA": "被害者 背景",
  "LESIONES": "けが",
  "RELACIÓN CON EL AUTOR (V. GÉNERO)": "関係 と 加害者 (ジェンダー暴力)",
  "INDICADORES DE RIESGO (I)": "リスク指標",
  "INDICADORES DE RIESGO (II)": "リスク指標",
  "ANTECEDENTES Y MENORES": "背景 と",
  "PROTECCIÓN Y APOYO": "と",
  "VALORACIÓN V. DOMÉSTICA": "家庭内暴力 評価",
  "CONTEXTO DE RELACIÓN": "関係 背景",
  "MÉTODO DE SUSTRACCIÓN": "窃盗 方法",
  "ESPECIFIQUE OTRO MÉTODO DE SUSTRACCIÓN": "その他 窃盗 方法",
  "TIPO DE DAÑOS": "タイプ の 損害",
  "TIPO DE ESTABLECIMIENTO": "タイプ の",
  "ZONA DEL ESTABLECIMIENTO": "区域",
  "ESPECIFIQUE OTRO TIPO DE DAÑO": "その他 タイプ の 損害",
  "TELÉFONO": "電話",
  "MENSAJERÍA": "メッセージ手段",
  "OTRA": "その他",
  "LABORAL": "職場",
  ...
  "ALLANAMIENTO DE MORADA": "住居 侵入",
  "USURPACIÓN DE INMUEBLE": "財産 不法占拠",
  "OCUPACIÓN TEMPORAL": "一時占有",
  "VIVIENDA HABITUAL": "主たる住居",
  "SEGUNDA VIVIENDA": "第二 住居",
  "LOCAL": "施設",
  "NAVE": "倉庫",
  "SOLAR": "土地",
  "ESCALO": "よじ登り 侵入",
  ...
  "YA NO ESTÁN": "いいえ どれくらい ある",
  "NO SABE": "不明",
  "OBJETO ENTREGADO Y NO DEVUELTO": "",
  "DEPÓSITO / CUSTODIA": "/",
  "ALQUILER NO DEVUELTO": "",
  "ERROR DE ENTREGA": "",
  "PRÉSTAMO": "",
  "DEPÓSITO": "",
  "ALQUILER": "",
  ...
  "SIN INTIMIDACIÓN": "いいえ",
  "VERBAL": "",
  "GESTUAL": "",
  "ARMA BLANCA": "刃物",
  "ARMA DE FUEGO": "銃器",
  "OTRO OBJETO PELIGROSO": "その他",
  "DESCUIDO": "不注意",
  "ARREBATO": "",
  "BOLSILLO": "",
  "INHIBIDOR / SISTEMA ELECTRÓNICO": "妨害装置/電子システム",
  "OCULTACIÓN DE OBJETO": "の",
  "SUPERMERCADO": "",
  "FARMACIA": "",
  ...
  "IBAN, teléfono, email, URL, usuario...": "IBAN, 電話, email, URL, ...",
  "Ej.: 1250": ".: 1250",
  "Ej.: 3": ".: 3",
  "Ej.: 850": ".: 850",
  "Ej.: Banco X": ".: 銀行 X",
  ...
  "Sin objetos.": "いいえ 物品.",
  "X": "X",
  "Selecciona una NACIONALIDAD válida (usa las píldoras).": "国籍 ( その ).",
  "Selecciona un PAÍS de nacimiento válido (usa las píldoras).": "国 の 出生 ( その ).",
  "Si el país de nacimiento es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.": "その 国 の 出生 ですか , と ."
};
