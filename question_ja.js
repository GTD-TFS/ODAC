...
const UI_JA = {
  ...
  "A LA PERSONA": "対人",
  "EN COMERCIO (HORARIO LABORAL)": "店舗内（営業時間）",
  "EN DOMICILIO / ESTABLECIMIENTO": "住居 / 施設内",
  "TIPO DE AGRESIÓN": "暴行の種類",
  "ENTORNO FAMILIAR / AFECTIVO": "家族・親密関係",
  "OTRO (NO FAMILIAR)": "その他（非家族）",
  "DENUNCIA EN CALIDAD DE...": "申告区分",
  "PERJUDICADO": "被害者",
  "TESTIGO": "目撃者",
  "REPRESENTANTE LEGAL": "法定代理人",
  "EMPLEADO DE COMERCIO AFECTADO": "被害を受けた従業員",
  "FECHA, HORA Y LUGAR DEL HECHO": "日時と場所",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "日時（範囲）と場所",
  "Calle / establecimiento / municipio": "通り / 施設 / 市",
  "Calle / zona / municipio": "通り / 区域 / 市",
  "Domicilio / establecimiento / municipio": "住居 / 施設 / 市",
  "¿CÓMO TIENE CONOCIMIENTO DEL HECHO?": "どのようにして事実を知りましたか？",
  "A TRAVÉS DE LA POLICÍA": "警察を通じて",
  "EMPRESA DE SEGURIDAD": "警備会社",
  "POR TERCERAS PERSONAS": "第三者を通じて",
  "DESCUBRIMIENTO POSTERIOR AL HECHO": "事後に判明",
  "TESTIGO DE LOS HECHOS": "事実を目撃",
  "TESTIGO DIRECTO": "直接目撃",
  "CAMARAS DE SEGURIDAD": "防犯カメラ",
  "TRAS COMPROBAR PROPIEDAD FALTANTE": "所有物の不足に気付いて",
  "¿INTERACCIÓN CON EL AUTOR?": "加害者と接触はありましたか？",
  "NO": "いいえ",
  "SI, COMUNICACION / ACERCAMIENTO": "はい、会話・接近あり",
  "SI, FORCEJEO O AGRESION": "はい、もみ合い・暴行あり",
  "SI, INTIMIDACION SIN CONTACTO": "はい、接触のない脅迫あり",
  "¿PRESENTA LESIONES?": "けがはありますか？",
  "SI": "はい",
  "DESCRIBA BREVEMENTE LAS LESIONES": "けがを簡潔に記載してください",
  "¿APORTA PARTE MÉDICO?": "診断書を提出しますか？",
  "TIPO DE INTIMIDACIÓN": "脅迫・威嚇の種類",
  "OBJETOS SUSTRAÍDOS": "盗難 物品",
  "DESCRIPCIÓN FÍSICA DEL AUTOR/ES": "加害者の身体的特徴",
  "RESUMEN DE LOS HECHOS": "事実の要約",
  "¿COMO TIENE CONOCIMIENTO DEL HECHO?": "どのようにして事実を知りましたか？",
  "¿INTERACCION CON EL AUTOR?": "加害者と接触はありましたか？",
  "SI, COMUNICACION": "はい、会話あり",
  "¿APORTA INFORME MEDICO?": "診断書を提出しますか？",
  "¿AUTOR RETENIDO EN EL LUGAR?": "加害者は現場で確保されましたか？",
  "¿HAY CAMARAS DE SEGURIDAD?": "防犯カメラはありますか？",
  "SI, LAS APORTA EN ESTE ACTO": "はい、この場で提出します",
  "SI, LAS APORTARÁ EN SEDE JUDICIAL": "はい、司法手続で提出予定です",
  "SI, FACILITA CONTACTO PARA SU GESTION": "はい、取得のための連絡先を提供します",
  "GESTION DE GRABACIONES": "映像管理",
  "Establecimiento, contacto, ubicación, horario...": "施設名、連絡先、場所、営業時間...",
  "OBJETOS SUSTRAIDOS": "盗難 物品",
  "BREVE RESUMEN DE LOS HECHOS": "事実の概要",
  "MÉTODO DE ACCESO (BREVE)": "侵入方法（簡潔）",
  "Puerta forzada, ventana, escalo, rotura cerradura, ganzúa...": "ドア破壊, 窓, よじ登り, 鍵破損, ピッキング...",
  "¿SE PRODUJERON DAÑOS?": "損害はありましたか？",
  "¿APORTA PRESUPUESTO DE REPARACIÓN?": "修理見積書を提出しますか？",
  "DESCRIPCIÓN DE LOS DAÑOS": "損害の内容",
  "Describe brevemente los daños producidos...": "生じた損害を簡潔に記載してください...",
  "VALORACIÓN / PRESUPUESTO DE REPARACIÓN": "評価額 / 修理見積額",
  "Importe, empresa, nº presupuesto, fecha...": "金額、業者名、見積番号、日付...",
  "¿HA MANIPULADO EL LUGAR DE LOS HECHOS? (PARA CONOCIMIENTO DE LA BRIGADA DE POLICÍA CIENTÍFICA)": "現場に手を加えましたか？（鑑識の参考）",
  "¿SE HA PRODUCIDO SUSTRACCIÓN?": "盗難はありましたか？",
  "BREVE DESCRIPCIÓN FÍSICA DE LOS AUTORES": "加害者の身体的特徴（簡潔）",
  "Rasgos, ropa, edad aprox., altura, tatuajes...": "特徴, 服装, おおよその年齢, 身長, 入れ墨...",
  "DESCRIPCION DE LESIONES": "けがの内容",
  "¿APORTA PARTE MEDICO?": "診断書を提出しますか？",
  "¿CONOCE AL AUTOR DE LOS HECHOS?": "加害者を知っていますか？",
  "APORTE DATOS": "情報を記入",
  "DESCRIPCIÓN DEL AUTOR/ES": "加害者の説明",
  "VICTIMA": "被害者",
  "TIPO DE AFECTIVIDAD": "関係の種類",
  "AGRESIÓN DE PAREJA (HOMBRE A MUJER) - V. GÉNERO": "パートナー間暴力（男性から女性）- ジェンダー暴力",
  "RESTO DE CASOS - V. DOMÉSTICA": "その他の事案 - 家庭内暴力",
  "¿HAY CONVIVENCIA?": "同居していますか？",
  "¿TIENE LESIONES?": "けがはありますか？",
  "DESCRIBA LAS LESIONES": "けがの内容を記載してください",
  "¿ES SU PAREJA ACTUAL?": "現在のパートナーですか？",
  "¿CUANTO TIEMPO DE RELACION?": "関係はどのくらい続いていますか？",
  "¿Le ha agredido físicamente en otra ocasión?": "以前に身体的暴力を受けたことはありますか？",
  "¿Le ha insultado, humillado o amenazado?": "侮辱・屈辱・脅迫を受けたことはありますか？",
  "¿Le controla el teléfono, redes sociales o amistades?": "電話・SNS・交友関係を監視されますか？",
  "¿Le impide trabajar, estudiar o relacionarse?": "働く、学ぶ、交流することを妨げられますか？",
  "¿Le obliga o ha obligado a mantener relaciones sexuales?": "性的関係を強要されたことがありますか？",
  "¿Ha destruido objetos o amenazado con hacerlo?": "物を壊した、または壊すと脅したことはありますか？",
  "¿Le ha dicho que la va a matar?": "殺すと言われたことがありますか？",
  "¿Ha amenazado con suicidarse si usted lo deja?": "別れたら自殺すると脅されたことがありますか？",
  "¿Tiene acceso a armas, cuchillos u objetos peligrosos?": "武器・刃物・危険物にアクセスできますか？",
  "¿Consume alcohol o drogas de forma habitual?": "日常的に飲酒や薬物使用がありますか？",
  "Describe qué tipo de sustancias y habitualidad": "物質の種類と頻度を記載してください",
  "¿Se vuelve más violento cuando consume?": "使用時にさらに暴力的になりますか？",
  "¿Los episodios han aumentado en frecuencia o gravedad?": "事案の頻度や深刻さは増していますか？",
  "¿La violencia comenzó hace poco o lleva tiempo ocurriendo?": "暴力は最近始まりましたか、それとも以前から続いていますか？",
  "¿Ha intentado usted separarse anteriormente?": "以前に別れようとしたことがありますか？",
  "¿Qué ocurrió cuando lo intentó?": "その時何が起こりましたか？",
  "¿Hay menores que presencien los hechos?": "これらの出来事を目撃した未成年者はいますか？",
  "¿Ha agredido o amenazado alguna vez a los menores?": "未成年者に暴力や脅迫をしたことがありますか？",
  "¿Cree que los menores están en peligro?": "未成年者が危険な状態だと思いますか？",
  "¿Ha denunciado anteriormente estos hechos?": "これらの事実を以前に届け出たことがありますか？",
  "¿Tiene o ha tenido orden de protección?": "保護命令を現在または過去に受けていますか？",
  "¿Sobre el autor?": "加害者に対するものですか？",
  "¿DESEA SOLICITAR ORDEN DE PROTECCIÓN?": "保護命令を申請しますか？",
  "¿Está siendo atendida por servicios sociales o sanitarios?": "福祉・医療サービスの支援を受けていますか？",
  "¿Alguna persona de su entorno conoce la situación?": "周囲に状況を知っている人はいますか？",
  "¿Depende usted económicamente de él?": "経済的に彼に依存していますか？",
  "¿Cree usted que la situación puede empeorar?": "状況が悪化すると思いますか？",
  "¿Tiene miedo real por su vida?": "生命の危険を本当に感じますか？",
  "¿HECHOS EN PRESENCIA DE MENORES?": "未成年者の前で起きた事実ですか？",
  "¿HECHOS EN DOMICILIO FAMILIAR?": "家庭の住居内で起きた事実ですか？",
  "¿HECHOS ANTERIORES SIMILARES?": "これまでに同様の事実はありましたか？",
  "VÍNCULO CON EL AUTOR": "加害者との関係",
  "AUTOR VARÓN Y PAREJA (O SIMILAR AFECTIVIDAD EN EL PRESENTE O PASADO) - V. GÉNERO": "加害者が男性で、現在または過去のパートナー関係あり - ジェンダー暴力",
  "AUTOR/A DEL ENTORNO FAMILIAR - V. DOMÉSTICA": "家族関係の加害者 - 家庭内暴力",
  "OTRO": "その他",
  "NOMBRE Y/O RELACIÓN QUE LE UNE": "氏名および関係",
  "RELACIÓN QUE LE UNE AL AUTOR/A": "加害者との関係",
  "¿CUÁLES FUERON LAS AMENAZAS?": "どのような脅迫がありましたか？",
  "DESCRIPCIÓN DEL AUTOR": "加害者の説明",
  "AÑADA DATOS DEL AUTOR": "加害者情報を追加",
  "FECHA, HORA Y LUGAR DEL EXTRAVÍO": "遺失日時と場所",
  "OBJETOS EXTRAVIADOS": "遺失物",
  "CIRCUNSTANCIAS DEL EXTRAVÍO/PÉRDIDA": "遺失・紛失の状況",
  "DETALLE ADICIONAL (OPCIONAL)": "追加情報（任意）",
  "¿SE PRODUJO SUSTRACCIÓN DE OBJETOS?": "物品の盗難はありましたか？",
  "OBJETOS AFECTADOS/SUSTRAÍDOS": "被害/盗難物品",
  "¿HAY CÁMARAS DE SEGURIDAD?": "防犯カメラはありますか？",
  "GESTIÓN DE GRABACIONES": "映像管理",
  "¿APORTA INFORME/PARTE MÉDICO?": "診断書を提出しますか？",
  "¿SE PRODUJO SUSTRACCIÓN?": "盗難は発生しましたか？",
  "OBJETOS AFECTADOS": "被害物品",
  "DATOS / DESCRIPCIÓN DEL AUTOR": "加害者情報 / 説明",
  "TIPO DE COACCIÓN": "強要の種類",
  "ÁMBITO": "分野",
  "MEDIO UTILIZADO": "手段",
  "REITERACIÓN": "反復性",
  "NÚMERO APROXIMADO DE EVENTOS": "概算件数",
  "PERJUICIO PRINCIPAL": "主な被害",
  "SUBTIPO DE ESTAFA": "詐欺の類型",
  "FECHA, HORA Y LUGAR/CANAL DEL HECHO": "事実の日時・場所／チャネル",
  "OPERATIVA ECONÓMICA": "支払処理",
  "CANAL DE CONTACTO": "連絡手段",
  "INSTRUMENTO DE PAGO": "決済手段",
  "IMPORTE TOTAL ESTIMADO (€)": "推定総額 (€)",
  "NÚMERO APROXIMADO DE OPERACIONES": "概算取引件数",
  "IDENTIFICADORES Y EVIDENCIAS": "識別情報と証拠",
  "ENTIDAD BANCARIA (SI APLICA)": "銀行名（該当する場合）",
  "IDENTIFICADORES RELACIONADOS": "関連 識別情報",
  "EVIDENCIAS DISPONIBLES": "利用可能 証拠",
  "TIPO DE AMENAZA": "脅迫の種類",
  "ESPECIFIQUE OTRA AMENAZA": "その他の脅迫を記入",
  "SUBTIPO": "類型",
  "TIPO DE INMUEBLE": "不動産の種類",
  "MÉTODO DE ACCESO": "侵入方法",
  "ESPECIFIQUE OTRO MÉTODO DE ACCESO": "その他の侵入方法を記入",
  "SITUACIÓN ACTUAL": "現在の状況",
  "ORIGEN DE LA TENENCIA": "占有の経緯",
  "¿REQUIRIÓ LA DEVOLUCIÓN?": "返還を請求しましたか？",
  "FECHA DEL REQUERIMIENTO": "請求日",
  "MEDIO DEL REQUERIMIENTO": "請求手段",
  "RESPUESTA DEL REQUERIDO": "相手方の回答",
  "IMPORTE ESTIMADO (€)": "金額 (€)",
  "CONTEXTO DE LA VÍCTIMA": "被害者の状況",
  "LESIONES": "けが",
  "RELACIÓN CON EL AUTOR (V. GÉNERO)": "加害者との関係（ジェンダー暴力）",
  "INDICADORES DE RIESGO (I)": "リスク指標",
  "INDICADORES DE RIESGO (II)": "リスク指標",
  "ANTECEDENTES Y MENORES": "前歴・未成年者",
  "PROTECCIÓN Y APOYO": "保護・支援",
  "VALORACIÓN V. DOMÉSTICA": "家庭内暴力評価",
  "CONTEXTO DE RELACIÓN": "関係の状況",
  "MÉTODO DE SUSTRACCIÓN": "窃取方法",
  "ESPECIFIQUE OTRO MÉTODO DE SUSTRACCIÓN": "その他の窃取方法を記入",
  "TIPO DE DAÑOS": "損害の種類",
  "TIPO DE ESTABLECIMIENTO": "施設の種類",
  "ZONA DEL ESTABLECIMIENTO": "施設内エリア",
  "ESPECIFIQUE OTRO TIPO DE DAÑO": "その他の損害の種類を記入",
  "TELÉFONO": "電話",
  "MENSAJERÍA": "メッセージ手段",
  "OTRA": "その他",
  "LABORAL": "職場",
  ...
  "COMPRA/VENTA": "売買",
  "SUPLANTACIÓN": "なりすまし",
  "IMPEDIR HACER ALGO": "行為の阻止",
  "OBLIGAR A HACER ALGO": "行為の強要",
  "CONTROL DE MOVILIDAD": "行動制限",
  "ALLANAMIENTO DE MORADA": "住居侵入",
  "USURPACIÓN DE INMUEBLE": "不動産の不法占拠",
  "OCUPACIÓN TEMPORAL": "一時占有",
  "VIVIENDA HABITUAL": "主たる住居",
  "SEGUNDA VIVIENDA": "別荘・セカンドハウス",
  "LOCAL": "施設",
  "NAVE": "倉庫",
  "SOLAR": "土地",
  "ESCALO": "よじ登り侵入",
  "FRACTURA CERRADURA": "錠破壊",
  "FORZAMIENTO PUERTA": "ドア破壊",
  "FORZAMIENTO VENTANA": "窓破壊",
  "LLAVE FALSA / SUSTRAÍDA": "偽造/盗難鍵",
  "LLAVE FALSA / LLAVE SUSTRAÍDA": "偽造/盗難鍵",
  "SIGUEN DENTRO": "まだ内部にいる",
  "YA NO ESTÁN": "すでにいない",
  "NO SABE": "不明",
  "OBJETO ENTREGADO Y NO DEVUELTO": "引き渡した物が返却されない",
  "DEPÓSITO / CUSTODIA": "寄託 / 保管",
  "ALQUILER NO DEVUELTO": "返却されないレンタル品",
  "ERROR DE ENTREGA": "引渡しミス",
  "PRÉSTAMO": "貸付",
  "DEPÓSITO": "預かり",
  "ALQUILER": "賃貸",
  "RELACIÓN LABORAL": "労働関係",
  "WHATSAPP": "WHATSAPP",
  "BUROFAX": "内容証明郵便",
  "LLAMADA": "電話",
  "SE NIEGA": "拒否する",
  "NO CONTESTA": "応答しない",
  "PROMETE DEVOLVER": "返還を約束する",
  "AMENAZA": "脅迫",
  "AMENAZA DE MUERTE": "殺害の脅迫",
  "AMENAZA DE LESIÓN": "傷害の脅迫",
  "AMENAZA DE DAÑOS EN BIENES": "器物損壊をほのめかす脅迫",
  "AMENAZA A MENORES": "未成年者への脅迫",
  "AMENAZA CONDICIONAL": "条件付き脅迫",
  "SIN INTIMIDACIÓN": "脅迫なし",
  "VERBAL": "言葉による",
  "GESTUAL": "身振り",
  "ARMA BLANCA": "刃物",
  "ARMA DE FUEGO": "銃器",
  "OTRO OBJETO PELIGROSO": "その他の危険物",
  "DESCUIDO": "不注意",
  "ARREBATO": "ひったくり",
  "BOLSILLO": "すり",
  "INHIBIDOR / SISTEMA ELECTRÓNICO": "妨害装置/電子システム",
  "OCULTACIÓN DE OBJETO": "物品隠匿",
  "SUPERMERCADO": "スーパー",
  "FARMACIA": "薬局",
  "TIENDA ROPA / COMPLEMENTOS": "衣料/アクセサリー店",
  "ESTANCO / LOTERÍA": "たばこ店 / 宝くじ売り場",
  "HOSTELERÍA": "飲食業",
  "ALMACÉN": "倉庫",
  "LÍNEA DE CAJA": "レジ付近",
  "MOSTRADOR": "カウンター",
  ...
  "PUERTA": "ドア",
  "VENTANA": "窓",
  "TERRAZA / EXTERIOR": "テラス/屋外",
  "IBAN, teléfono, email, URL, usuario...": "IBAN、電話、メール、URL、ユーザー名...",
  "Ej.: 1250": "例: 1250",
  "Ej.: 3": "例: 3",
  "Ej.: 850": "例: 850",
  "Ej.: Banco X": "例: 銀行X",
  ...
  "BICICLETA": "自転車",
  "PATINETE": "キックボード",
  "PORTÁTIL / TABLET": "ノートPC / タブレット",
  "MOCHILA / BOLSO": "リュック/バッグ",
  "HOMBRE": "男性",
  "MUJER": "女性",
  "NO DETERMINADO": "不明",
  "DELGADA": "細身",
  "NORMAL": "普通",
  "FUERTE/CORPULENTA": "がっしり",
  "ATLÉTICA": "筋肉質",
  "NO DETERMINADA": "不明",
  "AÑADIR / EDITAR OBJETOS": "物品を追加 / 編集",
  "Sin objetos.": "物品なし。",
  "X": "X",
  "Selecciona una NACIONALIDAD válida (usa las píldoras).": "有効な国籍を選択してください（候補ボタンを使用）。",
  "Selecciona un PAÍS de nacimiento válido (usa las píldoras).": "有効な出生国を選択してください（候補ボタンを使用）。",
  "Si el país de nacimiento es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.": "出生国がスペインの場合は、県と市区町村を選択してください。"
};
...
Object.assign(UI_JA, {
  ...
  "ESPECIFIQUE OTRO CANAL DE CONTACTO": "その他の連絡手段を記入",
  "ESPECIFIQUE OTRO INSTRUMENTO DE PAGO": "その他の決済手段を記入",
  "ESPECIFIQUE OTRO TIPO DE INMUEBLE": "その他の不動産種別を記入",
  "INDIQUE QUÉ DAÑOS SE PRODUJERON": "どのような損害が生じたか記入",
  "ESPECIFIQUE OTRO SUBTIPO": "その他のサブタイプを記入",
  "ESPECIFIQUE OTRO ORIGEN DE LA TENENCIA": "その他の占有の由来を記入",
  "ESPECIFIQUE OTRA COACCIÓN": "その他の強要内容を記入",
  "ESPECIFIQUE OTRO ÁMBITO": "その他の範囲を記入",
  "ESPECIFIQUE OTRO PERJUICIO": "その他の不利益を記入",
