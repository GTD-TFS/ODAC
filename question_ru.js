...
Object.assign(UI_RU, {
  ...
  "ESPECIFIQUE OTRO TIPO DE ESTABLECIMIENTO": "УКАЖИТЕ ДРУГОЙ ТИП ЗАВЕДЕНИЯ",
  "ESPECIFIQUE OTRA ZONA DEL ESTABLECIMIENTO": "УКАЖИТЕ ДРУГУЮ ЗОНУ ЗАВЕДЕНИЯ",
  "ESPECIFIQUE OTRO SUBTIPO DE ESTAFA": "УКАЖИТЕ ДРУГОЙ ПОДТИП МОШЕННИЧЕСТВА",
  "ESPECIFIQUE OTRO CANAL DE CONTACTO": "УКАЖИТЕ ДРУГОЙ КАНАЛ СВЯЗИ",
  "ESPECIFIQUE OTRO INSTRUMENTO DE PAGO": "УКАЖИТЕ ДРУГОЙ ПЛАТЁЖНЫЙ ИНСТРУМЕНТ",
  "ESPECIFIQUE OTRO TIPO DE INMUEBLE": "УКАЖИТЕ ДРУГОЙ ТИП ОБЪЕКТА НЕДВИЖИМОСТИ",
  "INDIQUE QUÉ DAÑOS SE PRODUJERON": "УКАЖИТЕ, КАКИЕ ПОВРЕЖДЕНИЯ БЫЛИ ПРИЧИНЕНЫ",
  "ESPECIFIQUE OTRO SUBTIPO": "УКАЖИТЕ ДРУГОЙ ПОДТИП",
  "ESPECIFIQUE OTRO ORIGEN DE LA TENENCIA": "УКАЖИТЕ ДРУГОЕ ПРОИСХОЖДЕНИЕ ВЛАДЕНИЯ",
  "ESPECIFIQUE OTRA COACCIÓN": "УКАЖИТЕ ДРУГОЕ ПРИНУЖДЕНИЕ",
  "ESPECIFIQUE OTRO ÁMBITO": "УКАЖИТЕ ДРУГУЮ СФЕРУ",
  "ESPECIFIQUE OTRO PERJUICIO": "УКАЖИТЕ ДРУГОЙ УЩЕРБ",
  "Completa los campos obligatorios para continuar.": "Заполните обязательные поля, чтобы продолжить.",
  "Indica cuál es el otro documento de identidad.": "Укажите, какой именно другой документ удостоверения личности.",
  "El número de documento es obligatorio salvo que seleccione Indocumentado/Indocumentada.": "Номер документа обязателен, если не выбрано Без документов.",
  "Si el número empieza por letra corresponde a NIE. Seleccione NIE como tipo de documento.": "Если номер начинается с буквы, это NIE. Выберите NIE как тип документа.",
