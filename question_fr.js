...
const UI_FR = {
  ...
  "CARACTERÍSTICAS DEL HECHO": "INCIDENT CATEGORY",
  "EXTRAVÍO/PÉRDIDA": "🧳 LOSS / MISPLACEMENT",
  "SUSTRACCIÓN": "🕵️ ROBBERY / THEFT",
  "DAÑOS": "🧱 PROPERTY DAMAGE",
  "ESTAFA / ESTAFA INFORMÁTICA": "💳 🖥️ SCAM / ONLINE SCAM",
  "AGRESIÓN": "👊 ASSAULT / INJURY",
  "AMENAZAS": "🗣️ THREATS",
  "OTRO TIPO DE HECHO": "➡️ OTHER TYPE OF INCIDENT",
  "OTROS TIPOS DE HECHO": "OTHER INCIDENT TYPES",
  "ALLANAMIENTO / USURPACIÓN": "🏠 TRESPASS / SQUATTING",
  "APROPIACIÓN INDEBIDA": "📦 MISAPPROPRIATION",
  "COACCIONES": "🧷 COERCION",
  "CARÁCTER SEXUAL": "🔒 SEXUAL OFFENCE",
  "DENUNCIA GENÉRICA": "🧩 GENERIC REPORT",
  "OTROS": "OTHER",

  // ===== SELECTORES =====
  "¿DÓNDE SE PRODUCE LA SUSTRACCIÓN?": "WHERE DID THE THEFT OCCUR?",
  "A LA PERSONA": "FROM A PERSON",
  "EN COMERCIO (HORARIO LABORAL)": "IN A SHOP (OPEN HOURS)",
  "EN DOMICILIO / ESTABLECIMIENTO": "IN A HOME / PREMISES",

  "TIPO DE AGRESIÓN": "TYPE OF ASSAULT",
  "ENTORNO FAMILIAR / AFECTIVO": "FAMILY / INTIMATE CONTEXT",
  "OTRO (NO FAMILIAR)": "OTHER (NON-FAMILY)",

  // ===== COMUNES =====
  "DENUNCIA EN CALIDAD DE...": "REPORTING AS...",
  "PERJUDICADO": "VICTIM",
  "TESTIGO": "WITNESS",
  "REPRESENTANTE LEGAL": "LEGAL REPRESENTATIVE",
  "EMPLEADO DE COMERCIO AFECTADO": "AFFECTED EMPLOYEE",

  "FECHA, HORA Y LUGAR DEL HECHO": "DATE, TIME AND LOCATION",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATE, TIME RANGE AND LOCATION",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATE, TIME RANGE AND LOCATION",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATE, TIME RANGE AND LOCATION",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATE, TIME RANGE AND LOCATION",
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATE, TIME RANGE AND LOCATION",
  ...
  "¿CÓMO TIENE CONOCIMIENTO DEL HECHO?": "HOW DID YOU BECOME AWARE OF THE INCIDENT?",
  "A TRAVÉS DE LA POLICÍA": "THROUGH THE POLICE",
  "EMPRESA DE SEGURIDAD": "SECURITY COMPANY",
  "POR TERCERAS PERSONAS": "THROUGH THIRD PARTIES",
  "DESCUBRIMIENTO POSTERIOR AL HECHO": "DISCOVERED AFTERWARDS",
  "TESTIGO DE LOS HECHOS": "WITNESS TO THE INCIDENT",
  "TESTIGO DIRECTO": "DIRECT WITNESS",
  "CAMARAS DE SEGURIDAD": "CCTV",
  "TRAS COMPROBAR PROPIEDAD FALTANTE": "AFTER NOTICING PROPERTY MISSING",

  // ===== HURTO_RVI =====
  "¿INTERACCIÓN CON EL AUTOR?": "DID YOU INTERACT WITH THE OFFENDER?",
  "NO": "NO",
  "SI, COMUNICACION / ACERCAMIENTO": "YES, COMMUNICATION / APPROACH",
  "SI, FORCEJEO O AGRESION": "YES, STRUGGLE OR ASSAULT",
  "SI, INTIMIDACION SIN CONTACTO": "YES, THREATS WITHOUT CONTACT",
  "¿PRESENTA LESIONES?": "DO YOU HAVE INJURIES?",
  "SI": "YES",
  "DESCRIBA BREVEMENTE LAS LESIONES": "BRIEFLY DESCRIBE THE INJURIES",
  "¿APORTA PARTE MÉDICO?": "DO YOU PROVIDE A MEDICAL REPORT?",
  "TIPO DE INTIMIDACIÓN": "TYPE OF THREAT/INTIMIDATION",
  "OBJETOS SUSTRAÍDOS": "STOLEN ITEMS",
  "DESCRIPCIÓN FÍSICA DEL AUTOR/ES": "PHYSICAL DESCRIPTION OF OFFENDER(S)",
  "RESUMEN DE LOS HECHOS": "SUMMARY OF EVENTS",

  // ===== PATRIMONIO =====
  "¿COMO TIENE CONOCIMIENTO DEL HECHO?": "HOW DID YOU BECOME AWARE OF THE INCIDENT?",
  "¿INTERACCION CON EL AUTOR?": "DID YOU INTERACT WITH THE OFFENDER?",
  "SI, COMUNICACION": "YES, COMMUNICATION",
  "¿APORTA INFORME MEDICO?": "DO YOU PROVIDE A MEDICAL REPORT?",
  "¿AUTOR RETENIDO EN EL LUGAR?": "IS THE OFFENDER HELD ON SITE?",
  "¿HAY CAMARAS DE SEGURIDAD?": "IS THERE CCTV?",
  "SI, LAS APORTA EN ESTE ACTO": "YES, PROVIDED NOW",
  "SI, LAS APORTARÁ EN SEDE JUDICIAL": "YES, WILL BE PROVIDED TO COURT",
  "SI, FACILITA CONTACTO PARA SU GESTION": "YES, PROVIDE CONTACT FOR COLLECTION",
  "GESTION DE GRABACIONES": "CCTV HANDLING",
  "Establecimiento, contacto, ubicación, horario...": "Premises, contact, address, opening hours...",
  "OBJETOS SUSTRAIDOS": "STOLEN ITEMS",
  "BREVE RESUMEN DE LOS HECHOS": "BRIEF SUMMARY",

  // ===== ROBO_FUERZA =====
  "FECHA, INTERVALO HORARIO Y LUGAR DEL HECHO": "DATE, TIME RANGE AND LOCATION",
  "MÉTODO DE ACCESO (BREVE)": "METHOD OF ENTRY (BRIEF)",
  "Puerta forzada, ventana, escalo, rotura cerradura, ganzúa...": "Forced door, window, climbing, lock broken, lockpick...",
  "¿SE PRODUJERON DAÑOS?": "WAS THERE DAMAGE?",
  "¿APORTA PRESUPUESTO DE REPARACIÓN?": "DO YOU PROVIDE A REPAIR QUOTE?",
  "DESCRIPCIÓN DE LOS DAÑOS": "DESCRIPTION OF DAMAGE",
  "Describe brevemente los daños producidos...": "Briefly describe the damage...",
  "VALORACIÓN / PRESUPUESTO DE REPARACIÓN": "VALUATION / REPAIR QUOTE",
  "Importe, empresa, nº presupuesto, fecha...": "Amount, company, quote no., date...",
  ...
  "¿SE HA PRODUCIDO SUSTRACCIÓN?": "WAS ANYTHING STOLEN?",
  "OBJETOS SUSTRAÍDOS": "STOLEN ITEMS",
  "BREVE DESCRIPCIÓN FÍSICA DE LOS AUTORES": "BRIEF PHYSICAL DESCRIPTION OF OFFENDER(S)",
  ...
  // ===== LESIONES =====
  "DESCRIPCION DE LESIONES": "DESCRIPTION OF INJURIES",
  "¿APORTA PARTE MEDICO?": "DO YOU PROVIDE A MEDICAL REPORT?",
  "¿CONOCE AL AUTOR DE LOS HECHOS?": "DO YOU KNOW THE OFFENDER?",
  "APORTE DATOS": "PROVIDE DETAILS",
  "DESCRIPCIÓN DEL AUTOR/ES": "DESCRIPTION OF OFFENDER(S)",

  // ===== AGRESION_FAMILIAR_AFECTIVO =====
  "DENUNCIA EN CALIDAD DE...": "REPORTING AS...",
  "VICTIMA": "VICTIM",
  "TIPO DE AFECTIVIDAD": "RELATIONSHIP TYPE",
  "AGRESIÓN DE PAREJA (HOMBRE A MUJER) - V. GÉNERO": "INTIMATE PARTNER VIOLENCE (MALE TO FEMALE) - GENDER VIOLENCE",
  "RESTO DE CASOS - V. DOMÉSTICA": "OTHER CASES - DOMESTIC VIOLENCE",
  "¿HAY CONVIVENCIA?": "DO YOU LIVE TOGETHER?",
  "¿TIENE LESIONES?": "DO YOU HAVE INJURIES?",
  "DESCRIBA LAS LESIONES": "DESCRIBE THE INJURIES",
  "¿APORTA INFORME MEDICO?": "DO YOU PROVIDE A MEDICAL REPORT?",
  "¿ES SU PAREJA ACTUAL?": "IS HE YOUR CURRENT PARTNER?",
  "¿CUANTO TIEMPO DE RELACION?": "HOW LONG HAVE YOU BEEN IN THIS RELATIONSHIP?",
  ...
  "¿Le controla el teléfono, redes sociales o amistades?": "DOES HE CONTROL YOUR PHONE, SOCIAL MEDIA OR FRIENDSHIPS?",
  ...
  "Describe qué tipo de sustancias y habitualidad": "DESCRIBE SUBSTANCES AND FREQUENCY",
  ...
  "¿Hay menores que presencien los hechos?": "ARE THERE MINORS WHO WITNESS THE INCIDENTS?",
  "¿Ha agredido o amenazado alguna vez a los menores?": "HAS HE EVER ASSAULTED OR THREATENED THE MINORS?",
  "¿Cree que los menores están en peligro?": "DO YOU BELIEVE THE MINORS ARE AT RISK?",
  "¿Ha denunciado anteriormente estos hechos?": "HAVE YOU REPORTED THESE FACTS BEFORE?",
  "¿Tiene o ha tenido orden de protección?": "DO YOU HAVE / HAVE YOU HAD A PROTECTION ORDER?",
  "¿Sobre el autor?": "AGAINST THE OFFENDER?",
  "¿DESEA SOLICITAR ORDEN DE PROTECCIÓN?": "DO YOU WANT TO REQUEST A PROTECTION ORDER?",
  ...
  "¿Cree usted que la situación puede empeorar?": "DO YOU THINK THE SITUATION MAY WORSEN?",
  "¿Tiene miedo real por su vida?": "ARE YOU GENUINELY AFRAID FOR YOUR LIFE?",

  // VD block
  "¿HECHOS EN PRESENCIA DE MENORES?": "INCIDENTS IN THE PRESENCE OF MINORS?",
  "¿HECHOS EN DOMICILIO FAMILIAR?": "INCIDENTS AT THE FAMILY HOME?",
  "¿HECHOS ANTERIORES SIMILARES?": "SIMILAR PREVIOUS INCIDENTS?",

  // ===== AMENAZAS_GLOBAL =====
  "VÍNCULO CON EL AUTOR": "RELATIONSHIP TO THE OFFENDER",
  ...
  "OTRO": "OTHER",
  "NOMBRE Y/O RELACIÓN QUE LE UNE": "NAME AND/OR RELATIONSHIP",
  "RELACIÓN QUE LE UNE AL AUTOR/A": "RELATIONSHIP DETAILS",
  "¿CUÁLES FUERON LAS AMENAZAS?": "WHAT WERE THE THREATS?",
  "DESCRIPCIÓN DEL AUTOR": "DESCRIPTION OF OFFENDER",

  // ===== CARACTER_SEXUAL =====
  "AÑADA DATOS DEL AUTOR": "ADD OFFENDER DETAILS",
  "DESCRIPCIÓN DEL AUTOR": "DESCRIPTION OF OFFENDER",

  // ===== EXTRAVIO =====
  "FECHA, HORA Y LUGAR DEL EXTRAVÍO": "DATE, TIME AND PLACE OF LOSS",
  "OBJETOS EXTRAVIADOS": "LOST ITEMS",
  "CIRCUNSTANCIAS DEL EXTRAVÍO/PÉRDIDA": "CIRCUMSTANCES OF THE LOSS",

  // ===== OTROS =====
  "BREVE RESUMEN DE LOS HECHOS": "BRIEF SUMMARY",
  "RESUMEN DE LOS HECHOS": "SUMMARY OF EVENTS",
  "DETALLE ADICIONAL (OPCIONAL)": "ADDITIONAL DETAIL (OPTIONAL)",
  "¿SE PRODUJO SUSTRACCIÓN DE OBJETOS?": "WAS THERE THEFT OF OBJECTS?",
  "OBJETOS AFECTADOS/SUSTRAÍDOS": "AFFECTED/STOLEN OBJECTS",
  "¿HAY CÁMARAS DE SEGURIDAD?": "ARE THERE SECURITY CAMERAS?",
  "GESTIÓN DE GRABACIONES": "RECORDING MANAGEMENT",
  "¿APORTA INFORME/PARTE MÉDICO?": "DO YOU PROVIDE A MEDICAL REPORT?",
  "¿SE PRODUJO SUSTRACCIÓN?": "WAS THERE THEFT?",
  "OBJETOS AFECTADOS": "AFFECTED ITEMS",
  "DATOS / DESCRIPCIÓN DEL AUTOR": "OFFENDER DETAILS / DESCRIPTION",
  "DESCRIPCIÓN DEL AUTOR/ES": "DESCRIPTION OF OFFENDER(S)",
  "TIPO DE COACCIÓN": "TYPE OF COERCION",
  "ÁMBITO": "SCOPE",
  "MEDIO UTILIZADO": "MEANS USED",
  "REITERACIÓN": "REPETITION",
  "NÚMERO APROXIMADO DE EVENTOS": "APPROXIMATE NUMBER OF EVENTS",
  "PERJUICIO PRINCIPAL": "MAIN HARM",
  "SUBTIPO DE ESTAFA": "SCAM SUBTYPE",
  "FECHA, HORA Y LUGAR/CANAL DEL HECHO": "DATE, TIME AND PLACE/CHANNEL OF THE INCIDENT",
  "OPERATIVA ECONÓMICA": "PAYMENT OPERATION",
  "CANAL DE CONTACTO": "CONTACT CHANNEL",
  "INSTRUMENTO DE PAGO": "PAYMENT INSTRUMENT",
  "IMPORTE TOTAL ESTIMADO (€)": "ESTIMATED TOTAL AMOUNT (€)",
  "NÚMERO APROXIMADO DE OPERACIONES": "APPROXIMATE NUMBER OF TRANSACTIONS",
  "IDENTIFICADORES Y EVIDENCIAS": "IDENTIFIERS AND EVIDENCE",
  "ENTIDAD BANCARIA (SI APLICA)": "BANK ENTITY (IF APPLICABLE)",
  "IDENTIFICADORES RELACIONADOS": "RELATED IDENTIFIERS",
  "EVIDENCIAS DISPONIBLES": "AVAILABLE EVIDENCE",
  "TIPO DE AMENAZA": "TYPE OF THREAT",
  "ESPECIFIQUE OTRA AMENAZA": "SPECIFY OTHER THREAT",
  "SUBTIPO": "SUBTYPE",
  "TIPO DE INMUEBLE": "PROPERTY TYPE",
  "MÉTODO DE ACCESO": "ACCESS METHOD",
  "ESPECIFIQUE OTRO MÉTODO DE ACCESO": "SPECIFY OTHER ACCESS METHOD",
  "SITUACIÓN ACTUAL": "CURRENT SITUATION",
  "ORIGEN DE LA TENENCIA": "ORIGIN OF POSSESSION",
  "¿REQUIRIÓ LA DEVOLUCIÓN?": "DID YOU REQUEST RETURN?",
  "FECHA DEL REQUERIMIENTO": "DATE OF REQUEST",
  "MEDIO DEL REQUERIMIENTO": "REQUEST CHANNEL",
  "RESPUESTA DEL REQUERIDO": "RESPONSE OF REQUESTED PARTY",
  "IMPORTE ESTIMADO (€)": "ESTIMATED AMOUNT (€)",
  "CONTEXTO DE LA VÍCTIMA": "VICTIM CONTEXT",
  "LESIONES": "INJURIES",
  "RELACIÓN CON EL AUTOR (V. GÉNERO)": "RELATIONSHIP WITH OFFENDER (GENDER VIOLENCE)",
  "INDICADORES DE RIESGO (I)": "RISK INDICATORS (I)",
  "INDICADORES DE RIESGO (II)": "RISK INDICATORS (II)",
  "ANTECEDENTES Y MENORES": "BACKGROUND AND MINORS",
  "PROTECCIÓN Y APOYO": "PROTECTION AND SUPPORT",
  "VALORACIÓN V. DOMÉSTICA": "DOMESTIC VIOLENCE ASSESSMENT",
  "CONTEXTO DE RELACIÓN": "RELATIONSHIP CONTEXT",
  "¿CUÁLES FUERON LAS AMENAZAS?": "WHAT WERE THE THREATS?",
  "MÉTODO DE SUSTRACCIÓN": "THEFT METHOD",
  "ESPECIFIQUE OTRO MÉTODO DE SUSTRACCIÓN": "SPECIFY OTHER THEFT METHOD",
  "TIPO DE DAÑOS": "TYPE OF DAMAGE",
  "TIPO DE ESTABLECIMIENTO": "TYPE OF ESTABLISHMENT",
  "ZONA DEL ESTABLECIMIENTO": "ESTABLISHMENT AREA",
  "ESPECIFIQUE OTRO TIPO DE DAÑO": "SPECIFY OTHER TYPE OF DAMAGE",
  ...
  "NAVE": "WAREHOUSE",
  "SOLAR": "LOT/LAND",
  "ESCALO": "CLIMBING ENTRY",
  "FRACTURA CERRADURA": "LOCK BREAK",
  "FORZAMIENTO PUERTA": "FORCED DOOR",
  "FORZAMIENTO VENTANA": "FORCED WINDOW",
  "LLAVE FALSA / SUSTRAÍDA": "FALSE/STOLEN KEY",
  "LLAVE FALSA / LLAVE SUSTRAÍDA": "FALSE/STOLEN KEY",
  "SIGUEN DENTRO": "STILL INSIDE",
  "YA NO ESTÁN": "NO LONGER THERE",
  "NO SABE": "UNKNOWN",
  ...
  "DEPÓSITO": "DEPOSIT",
  "ALQUILER": "RENTAL",
  "RELACIÓN LABORAL": "WORK RELATIONSHIP",
  "WHATSAPP": "WHATSAPP",
  "BUROFAX": "BUROFAX",
  "LLAMADA": "CALL",
  "SE NIEGA": "REFUSES",
  "NO CONTESTA": "NO RESPONSE",
  "PROMETE DEVOLVER": "PROMISES TO RETURN",
  "AMENAZA DE MUERTE": "DEATH THREAT",
  "AMENAZA DE LESIÓN": "INJURY THREAT",
  "AMENAZA DE DAÑOS EN BIENES": "THREAT OF PROPERTY DAMAGE",
  "AMENAZA A MENORES": "THREAT TO MINORS",
  "AMENAZA CONDICIONAL": "CONDITIONAL THREAT",
  "SIN INTIMIDACIÓN": "NO INTIMIDATION",
  "VERBAL": "VERBALE",
  "Web, app, teléfono, comercio, municipio...": "Site web, application, téléphone, commerce, commune...",
  ...
  "OTRO OBJETO PELIGROSO": "OTHER DANGEROUS OBJECT",
  "DESCUIDO": "LAPSE/CARELESSNESS",
  "ARREBATO": "SNATCHING",
  "BOLSILLO": "POCKET",
  "INHIBIDOR / SISTEMA ELECTRÓNICO": "JAMMER / ELECTRONIC SYSTEM",
  "OCULTACIÓN DE OBJETO": "CONCEALMENT OF OBJECT",
  "SUPERMERCADO": "SUPERMARKET",
  "FARMACIA": "PHARMACY",
  "TIENDA ROPA / COMPLEMENTOS": "CLOTHING / ACCESSORIES STORE",
  "ESTANCO / LOTERÍA": "TOBACCO / LOTTERY SHOP",
  "HOSTELERÍA": "HOSPITALITY",
  "ALMACÉN": "STORAGE",
  "LÍNEA DE CAJA": "CHECKOUT LINE",
  "MOSTRADOR": "COUNTER",
  ...
  "PUERTA": "DOOR",
  "VENTANA": "WINDOW",
  "TERRAZA / EXTERIOR": "TERRACE / OUTDOOR",
  "IBAN, teléfono, email, URL, usuario...": "IBAN, phone, email, URL, username...",
  "Ej.: 1250": "Ex.: 1250",
  "Ej.: 3": "Ex.: 3",
  "Ej.: 850": "Ex.: 850",
  "Ej.: Banco X": "Ex.: Bank X",

  // Object/author option values shown in modal
  "MÓVIL": "MOBILE PHONE",
  "CARTERA / MONEDERO": "WALLET / PURSE",
  ...
  "MOCHILA / BOLSO": "BACKPACK / BAG",
  "HOMBRE": "MALE",
  "MUJER": "FEMALE",
  "NO DETERMINADO": "UNDETERMINED",
  "DELGADA": "SLIM",
  "NORMAL": "AVERAGE",
  "FUERTE/CORPULENTA": "STRONG/STOCKY",
  "ATLÉTICA": "ATHLETIC",
  "NO DETERMINADA": "UNDETERMINED",

  // ===== OBJETOS MODAL =====
  "AÑADIR / EDITAR OBJETOS": "ADD / EDIT ITEMS",
  "Sin objetos.": "No items.",
  "X": "X",

  // ===== VALIDACIÓN =====
  "Selecciona una NACIONALIDAD válida (usa las píldoras).":
    "Select a valid NATIONALITY (use the pills).",
  "Selecciona un PAÍS de nacimiento válido (usa las píldoras).":
    "Select a valid COUNTRY OF BIRTH (use the pills).",
  "Si el país de nacimiento es ESPAÑA, selecciona PROVINCIA y MUNICIPIO.":
    "If the country of birth is SPAIN, select PROVINCE and MUNICIPALITY."
};
...
(function localizeFR(ui){
  const EXACT = {
    "INCIDENT CATEGORY":"CATÉGORIE DE L'INCIDENT",
    "🧳 LOSS / MISPLACEMENT":"🧳 PERTE / ÉGAREMENT",
    "🕵️ ROBBERY / THEFT":"🕵️ VOL / LARCIN",
    "🧱 PROPERTY DAMAGE":"🧱 DÉGÂTS MATÉRIELS",
    "💳 🖥️ SCAM / ONLINE SCAM":"💳 🖥️ ESCROQUERIE / ESCROQUERIE EN LIGNE",
    "👊 ASSAULT / INJURY":"👊 AGRESSION / BLESSURE",
    "🗣️ THREATS":"🗣️ MENACES",
    "➡️ OTHER TYPE OF INCIDENT":"➡️ AUTRE TYPE DE FAIT",
    "OTHER INCIDENT TYPES":"AUTRES TYPES DE FAITS",
    "🏠 TRESPASS / SQUATTING":"🏠 INTRUSION / OCCUPATION ILLÉGALE",
    "📦 MISAPPROPRIATION":"📦 APPROPRIATION INDUE",
    "🧷 COERCION":"🧷 COACTION",
    "🔒 SEXUAL OFFENCE":"🔒 INFRACTION SEXUELLE",
    "🧩 GENERIC REPORT":"🧩 DÉNONCIATION GÉNÉRIQUE",
    "WHERE DID THE THEFT OCCUR?":"OÙ A EU LIEU LA SOUSTRACTION ?",
    "FROM A PERSON":"À LA PERSONNE",
    "IN A SHOP (OPEN HOURS)":"DANS UN COMMERCE (HEURES D'OUVERTURE)",
    "IN A HOME / PREMISES":"DANS UN DOMICILE / ÉTABLISSEMENT",
    "TYPE OF ASSAULT":"TYPE D'AGRESSION",
    "FAMILY / INTIMATE CONTEXT":"CONTEXTE FAMILIAL / AFFECTIF",
    "OTHER (NON-FAMILY)":"AUTRE (NON FAMILIAL)",
    "REPORTING AS...":"DÉCLARATION EN QUALITÉ DE...",
    "VICTIM":"VICTIME",
    "WITNESS":"TÉMOIN",
    "LEGAL REPRESENTATIVE":"REPRÉSENTANT LÉGAL",
    "DATE, TIME AND LOCATION":"DATE, HEURE ET LIEU",
    "DATE, TIME RANGE AND LOCATION":"DATE, INTERVALLE HORAIRE ET LIEU",
    "SUMMARY OF EVENTS":"RÉSUMÉ DES FAITS",
    "ADD / EDIT ITEMS":"AJOUTER / ÉDITER OBJETS",
    "AFFECTED/STOLEN OBJECTS":"OBJETS CONCERNÉS/SOUSTRAITS",
    "WAS THERE THEFT OF OBJECTS?":"Y A-T-IL EU SOUSTRACTION D'OBJETS ?",
    "ARE THERE SECURITY CAMERAS?":"Y A-T-IL DES CAMÉRAS DE SÉCURITÉ ?",
    "RECORDING MANAGEMENT":"GESTION DES ENREGISTREMENTS",
    "Web, app, teléfono, comercio, municipio...":"Web, application, téléphone, commerce, commune...",
    "Calle / domicilio / trabajo / municipio":"Rue / domicile / travail / commune",
    "Domicilio / local / nave / municipio":"Domicile / local / entrepôt / commune",
    "HOW DID YOU BECOME AWARE OF THE INCIDENT?":"COMMENT AVEZ-VOUS EU CONNAISSANCE DES FAITS ?",
    "THROUGH THE POLICE":"PAR LA POLICE",
    "THROUGH THIRD PARTIES":"PAR DES TIERS",
    "CCTV":"VIDÉOSURVEILLANCE",
    "DID YOU INTERACT WITH THE OFFENDER?":"AVEZ-VOUS INTERAGI AVEC L'AUTEUR ?",
    "DO YOU HAVE INJURIES?":"PRÉSENTEZ-VOUS DES BLESSURES ?",
    "DO YOU PROVIDE A MEDICAL REPORT?":"FOURNISSEZ-VOUS UN RAPPORT MÉDICAL ?",
    "TYPE OF THREAT/INTIMIDATION":"TYPE DE MENACE/INTIMIDATION",
    "IS THERE CCTV?":"Y A-T-IL DE LA VIDÉOSURVEILLANCE ?",
    "CCTV HANDLING":"GESTION DES ENREGISTREMENTS VIDÉO",
    "METHOD OF ENTRY (BRIEF)":"MÉTHODE D'ACCÈS (BRÈVE)",
    "WAS THERE DAMAGE?":"Y A-T-IL EU DES DÉGÂTS ?",
    "DO YOU PROVIDE A REPAIR QUOTE?":"FOURNISSEZ-VOUS UN DEVIS DE RÉPARATION ?",
    "WAS ANYTHING STOLEN?":"Y A-T-IL EU SOUSTRACTION ?",
    "BRIEF PHYSICAL DESCRIPTION OF OFFENDER(S)":"BRÈVE DESCRIPTION PHYSIQUE DE(S) AUTEUR(S)",
    "DO YOU KNOW THE OFFENDER?":"CONNAISSEZ-VOUS L'AUTEUR ?",
    "DO YOU LIVE TOGETHER?":"VIVEZ-VOUS ENSEMBLE ?",
    ...
    "DO YOU BELIEVE THE MINORS ARE AT RISK?":"PENSEZ-VOUS QUE LES MINEURS SONT EN DANGER ?",
    "DO YOU HAVE / HAVE YOU HAD A PROTECTION ORDER?":"AVEZ-VOUS / AVEZ-VOUS EU UNE ORDONNANCE DE PROTECTION ?",
    "DO YOU WANT TO REQUEST A PROTECTION ORDER?":"SOUHAITEZ-VOUS DEMANDER UNE ORDONNANCE DE PROTECTION ?",
    ...
    "DO YOU THINK THE SITUATION MAY WORSEN?":"PENSEZ-VOUS QUE LA SITUATION PEUT S'AGGRAVER ?",
    ...
    "SPECIFY OTHER THREAT":"PRÉCISEZ UNE AUTRE MENACE",
    "DID YOU REQUEST RETURN?":"AVEZ-VOUS DEMANDÉ LA RESTITUTION ?",
    "UNKNOWN":"INCONNU",
    "THREAT OF PROPERTY DAMAGE":"MENACE DE DÉGÂTS MATÉRIELS",
